...
(function () {
    if (window.CKEDITOR && window.CKEDITOR.dom) return; window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            timestamp: "K87C", version: "4.15.0", revision: "cc4885b53", rnd: Math.floor(900 * Math.random()) + 100, _: { pending: [], basePathSrcPattern: a }, status: "unloaded", basePath: function () {
            ...
            once: function () { var a = Array.prototype.slice.call(arguments), b = a[1]; a[1] = function (a) { a.removeListener(); return b.apply(this, arguments) }; return this.on.apply(this, a) }, capture: function () { CKEDITOR.event.useCapture = 1; var a = this.on.apply(this, arguments); CKEDITOR.event.useCapture = 0; return a }, fire: function () {
                var a = 0, b = function () { a = 1 }, h = 0, k = function () { h = 1 }; return function (g, l, u) {
                    var e = d(this)[g]; g = a; var x = h; a = h = 0; if (e) {
                        var w = e.listeners; if (w.length) for (var w = w.slice(0), z, H = 0; H < w.length; H++) {
                            if (e.errorProof) try {
                                z =
                                w[H].call(this, u, l, b, k)
                            } catch (t) { } else z = w[H].call(this, u, l, b, k); !1 === z ? h = 1 : "undefined" != typeof z && (l = z); if (a || h) break
                        }
    ...
    (function () {
        function a(a, b, e) { this._minInterval = a; this._context = e; this._lastOutput = this._scheduledTimer = 0; this._output = CKEDITOR.tools.bind(b, e || {}); var c = this; this.input = function () { function a() { c._lastOutput = (new Date).getTime(); c._scheduledTimer = 0; c._call() } if (!c._scheduledTimer || !1 !== c._reschedule()) { var x = (new Date).getTime() - c._lastOutput; x < c._minInterval ? c._scheduledTimer = setTimeout(a, c._minInterval - x) : a() } } } function d(x, b, e) {
            ...
            }, capitalize: function (a, b) { return a.charAt(0).toUpperCase() + (b ? a.slice(1) : a.slice(1).toLowerCase()) }, extend: function (a) { var b = arguments.length, e, c; "boolean" == typeof (e = arguments[b - 1]) ? b-- : "boolean" == typeof (e = arguments[b - 2]) && (c = arguments[b - 1], b -= 2); for (var g = 1; g < b; g++) { var n = arguments[g] || {}; CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(n), function (b) { if (!0 === e || null == a[b]) if (!c || b in c) a[b] = n[b] }) } return a }, prototypedCopy: function (a) {
                var b = function () { };
            ...
            writeCssText: function (a, b) { var e, c = []; for (e in a) c.push(e + ":" + a[e]); b && c.sort(); return c.join("; ") }, objectCompare: function (a, b, e) { var c; if (!a && !b) return !0; if (!a || !b) return !1; for (c in a) if (a[c] != b[c]) return !1; if (!e) for (c in b) if (a[c] != b[c]) return !1; return !0 }, objectKeys: function (a) { return CKEDITOR.tools.object.keys(a) }, convertArrayToObject: function (a, b) { var e = {}; 1 == arguments.length && (b = !0); for (var c = 0, g = a.length; c < g; ++c)e[a[c]] = b; return e }, getStyledSpans: function (a, b) {
                var e = CKEDITOR.env.ie && 8 == CKEDITOR.env.version ?
                    a.toUpperCase() : a, e = b.find("span[style*\x3d" + e + "]").toArray(); return CKEDITOR.tools.array.filter(e, function (b) { return !!b.getStyle(a) })
            }, fixDomain: function () { for (var a; ;)try { a = window.parent.document.domain; break } catch (b) { a = a ? a.replace(/.+?(?:\.|$)/, "") : document.domain; if (!a) break; document.domain = a } return !!a }, eventsBuffer: function (a, b, e) { return new this.buffers.event(a, b, e) }, enableHtml5Elements: function (a, b) {
                for (var e = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "),
                    c = e.length, g; c--;)g = a.createElement(e[c]), b && a.appendChild(g)
            }, checkIfAnyArrayItemMatches: function (a, b) { for (var e = 0, c = a.length; e < c; ++e)if (a[e].match(b)) return !0; return !1 }, checkIfAnyObjectPropertyMatches: function (a, b) { for (var e in a) if (e.match(b)) return !0; return !1 }, keystrokeToString: function (a, b) { var e = this.keystrokeToArray(a, b); e.display = e.display.join("+"); e.aria = e.aria.join("+"); return e }, keystrokeToArray: function (a, b) {
                var e = b & 16711680, c = b & 65535, g = CKEDITOR.env.mac, n = [], d = []; e & CKEDITOR.CTRL && (n.push(g ?
                    "⌘" : a[17]), d.push(g ? a[224] : a[17])); e & CKEDITOR.ALT && (n.push(g ? "⌥" : a[18]), d.push(a[18])); e & CKEDITOR.SHIFT && (n.push(g ? "⇧" : a[16]), d.push(a[16])); c && (a[c] ? (n.push(a[c]), d.push(a[c])) : (n.push(String.fromCharCode(c)), d.push(String.fromCharCode(c)))); return { display: n, aria: d }
                ...
                a = a.toLowerCase(); for (var b = document.cookie.split(";"), e, c, g = 0; g < b.length; g++)if (e = b[g].split("\x3d"),
                    c = decodeURIComponent(CKEDITOR.tools.trim(e[0]).toLowerCase()), c === a) return decodeURIComponent(1 < e.length ? e[1] : ""); return null
                ...
                var a = CKEDITOR.tools.getCookie("ckCsrfToken"); if (!a || 40 != a.length) {
                    var a = [], b = ""; if (window.crypto && window.crypto.getRandomValues) a = new Uint8Array(40), window.crypto.getRandomValues(a); else for (var e = 0; 40 > e; e++)a.push(Math.floor(256 * Math.random()));
                    for (e = 0; e < a.length; e++)var c = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[e] % 36), b = b + (.5 < Math.random() ? c.toUpperCase() : c); a = b; CKEDITOR.tools.setCookie("ckCsrfToken", a)
                } return a
                ...
                if (!CKEDITOR.env.ie || 9 <= CKEDITOR.env.version &&
                    !CKEDITOR.env.ie6Compat) return a; for (var e = [[CKEDITOR.MOUSE_BUTTON_LEFT, 1], [CKEDITOR.MOUSE_BUTTON_MIDDLE, 4], [CKEDITOR.MOUSE_BUTTON_RIGHT, 2]], c = 0; c < e.length; c++) { var g = e[c]; if (g[0] === a && b) return g[1]; if (!b && g[1] === a) return g[0] }
                ...
                var b = "", e = a.length, c; for (c = 0; c < e; c += 3) {
                    var g = a.slice(c, c + 3), n = g.length, d = [], l; if (3 > n) for (l = n; 3 > l; l++)g[l] = 0; d[0] = (g[0] &
                        252) >> 2; d[1] = (g[0] & 3) << 4 | g[1] >> 4; d[2] = (g[1] & 15) << 2 | (g[2] & 192) >> 6; d[3] = g[2] & 63; for (l = 0; 4 > l; l++)b = l <= n ? b + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(d[l]) : b + "\x3d"
                } return b
            }, style: {
                parse: {
                    _colors: {
                        aliceblue: "#F0F8FF", antiquewhite: "#FAEBD7", aqua: "#00FFFF", aquamarine: "#7FFFD4", azure: "#F0FFFF", beige: "#F5F5DC", bisque: "#FFE4C4", black: "#000000", blanchedalmond: "#FFEBCD", blue: "#0000FF", blueviolet: "#8A2BE2", brown: "#A52A2A", burlywood: "#DEB887", cadetblue: "#5F9EA0", chartreuse: "#7FFF00",
                        ...
                        windowtext: "windowtext", wheat: "#F5DEB3", white: "#FFFFFF", whitesmoke: "#F5F5F5", yellow: "#FFFF00", yellowgreen: "#9ACD32"
                        ...
                        e.length && (b.color = e[0], CKEDITOR.tools.array.forEach(e, function (b) { a = a.replace(b, "") })); if (a = CKEDITOR.tools.trim(a)) b.unprocessed = a; return b
                        ...
                        function e(a) { c.top = g[a[0]]; c.right = g[a[1]]; c.bottom = g[a[2]]; c.left = g[a[3]] } var c = {}, g = b ? b(a) : a.split(/\s+/); switch (g.length) {
                            case 1: e([0, 0, 0, 0]); break; case 2: e([0,
                                1, 0, 1]); break; case 3: e([0, 1, 2, 1]); break; case 4: e([0, 1, 2, 3])
                        }return c
                ...
                filter: function (a, b, e) {
                    var c = []; this.forEach(a,
                        function (g, n) { b.call(e, g, n, a) && c.push(g) }); return c
                }, find: function (a, b, e) { for (var c = a.length, g = 0; g < c;) { if (b.call(e, a[g], g, a)) return a[g]; g++ } }, forEach: function (a, b, e) { var c = a.length, g; for (g = 0; g < c; g++)b.call(e, a[g], g, a) }, map: function (a, b, e) { for (var c = [], g = 0; g < a.length; g++)c.push(b.call(e, a[g], g, a)); return c }, reduce: function (a, b, e, c) { for (var g = 0; g < a.length; g++)e = b.call(c, e, a[g], g, a); return e }, every: function (a, b, e) { if (!a.length) return !0; b = this.filter(a, b, e); return a.length === b.length }, some: function (a,
                    b, e) { for (var c = 0; c < a.length; c++)if (b.call(e, a[c], c, a)) return !0; return !1 }
            }, object: {
                DONT_ENUMS: "toString toLocaleString valueOf hasOwnProperty isPrototypeOf propertyIsEnumerable constructor".split(" "), entries: function (a) { return CKEDITOR.tools.array.map(CKEDITOR.tools.object.keys(a), function (b) { return [b, a[b]] }) }, values: function (a) { return CKEDITOR.tools.array.map(CKEDITOR.tools.object.keys(a), function (b) { return a[b] }) }, keys: function (a) {
                    var b = Object.prototype.hasOwnProperty, e = [], c = CKEDITOR.tools.object.DONT_ENUMS;
                    if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version && (!a || "object" !== typeof a)) { b = []; if ("string" === typeof a) for (e = 0; e < a.length; e++)b.push(String(e)); return b } for (var g in a) e.push(g); if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version) for (g = 0; g < c.length; g++)b.call(a, c[g]) && e.push(c[g]); return e
                }, findKey: function (a, b) { if ("object" !== typeof a) return null; for (var e in a) if (a[e] === b) return e; return null }, merge: function (a, b) {
                    var e = CKEDITOR.tools, c = e.clone(a), g = e.clone(b); e.array.forEach(e.object.keys(g), function (a) {
                        c[a] =
                        "object" === typeof g[a] && "object" === typeof c[a] ? e.object.merge(c[a], g[a]) : g[a]
                    }); return c
                }
            }, getAbsoluteRectPosition: function (a, b) { function e(a) { if (a) { var b = a.getClientRect(); c.top += b.top; c.left += b.left; "x" in c && "y" in c && (c.x += b.x, c.y += b.y); e(a.getWindow().getFrame()) } } var c = CKEDITOR.tools.copy(b); e(a.getFrame()); var g = CKEDITOR.document.getWindow().getScrollPosition(); c.top += g.y; c.left += g.x; "x" in c && "y" in c && (c.y += g.y, c.x += g.x); c.right = c.left + c.width; c.bottom = c.top + c.height; return c }
        }; a.prototype = {
            reset: function () {
                this._lastOutput =
                0; this._clearTimer()
            }, _reschedule: function () { return !1 }, _call: function () { this._output() }, _clearTimer: function () { this._scheduledTimer && clearTimeout(this._scheduledTimer); this._scheduledTimer = 0 }
            ...
            CKEDITOR.tools.createClass({
                $: function (a) { a = a || {}; this.width = a.width; this.style = a.style; this.color = a.color; this._.normalize() }, _: { normalizeMap: { color: [[/windowtext/g, "black"]] }, normalize: function () { for (var a in this._.normalizeMap) { var b = this[a]; b && (this[a] = CKEDITOR.tools.array.reduce(this._.normalizeMap[a], function (a, b) { return a.replace(b[0], b[1]) }, b)) } } }, proto: { toString: function () { return CKEDITOR.tools.array.filter([this.width, this.style, this.color], function (a) { return !!a }).join(" ") } }, statics: {
                    fromCssRule: function (a) {
                        ...
                        b = b || {}; var e = CKEDITOR.tools.array.reduce(["width", "style", "color"], function (e, c) {
                            var g = a["border-" + c] || b[c]; e[c] = g ? CKEDITOR.tools.style.parse.sideShorthand(g) :
                                null; return e
                        }, {}); return CKEDITOR.tools.array.reduce(["top", "right", "bottom", "left"], function (b, c) { var g = {}, d; for (d in e) { var l = a["border-" + c + "-" + d]; g[d] = l ? l : e[d] && e[d][c] } b["border-" + c] = new CKEDITOR.tools.style.border(g); return b }, {})
                    }
                }
    ...
    (function () {
        function a(a, b) {
            var c = this.range; if (this._.end) return null; if (!this._.start) { this._.start = 1; if (c.collapsed) return this.end(), null; c.optimize() } var e, d = c.startContainer; e = c.endContainer; var f = c.startOffset, x = c.endOffset, h, g = this.guard, m = this.type, C = a ? "getPreviousSourceNode" : "getNextSourceNode"; if (!a && !this._.guardLTR) {
                var K = e.type == CKEDITOR.NODE_ELEMENT ? e : e.getParent(), A = e.type == CKEDITOR.NODE_ELEMENT ? e.getChild(x) : e.getNext(); this._.guardLTR = function (a, b) {
    ...
    (function () {
        function a(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset } function d(a, b, c, d, f) {
            function h(a, b, c, e) { var E = c ? a.getPrevious() : a.getNext(); if (e && k) return E; l || e ? b.append(a.clone(!0, f), c) : (a.remove(), u && b.append(a, c)); return E } function n() { var a, b, c, e = Math.min(R.length, p.length); for (a = 0; a < e; a++)if (b = R[a], c = p[a], !b.equals(c)) return a; return a - 1 } function g() {
                var b = N - 1, c = D && B && !m.equals(C); b < O - 1 || b < q - 1 || c ? (c ? a.moveToPosition(C,
            ...
            } a.optimizeBookmark(); var k = 0 === b, u = 1 == b, l = 2 == b; b = l || u; var m = a.startContainer, C = a.endContainer,
                K = a.startOffset, A = a.endOffset, M, r, D, B, v, S; if (l && C.type == CKEDITOR.NODE_TEXT && (m.equals(C) || m.type === CKEDITOR.NODE_ELEMENT && m.getFirst().equals(C))) c.append(a.document.createText(C.substring(K, A))); else {
                    C.type == CKEDITOR.NODE_TEXT ? l ? S = !0 : C = C.split(A) : 0 < C.getChildCount() ? A >= C.getChildCount() ? (C = C.getChild(A - 1), r = !0) : C = C.getChild(A) : B = r = !0; m.type == CKEDITOR.NODE_TEXT ? l ? v = !0 : m.split(K) : 0 < m.getChildCount() ? 0 === K ? (m = m.getChild(K), M = !0) : m = m.getChild(K - 1) : D = M = !0; for (var R = m.getParents(), p = C.getParents(), N = n(),
        ...
        function f(a) { return function () { var b; return this[a ? "getPreviousNode" : "getNextNode"](function (a) { !b && u(a) && (b = a); return l(a) && !(k(a) && a.equals(b)) }) } } var h = { abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1 }, k = CKEDITOR.dom.walker.bogus(), g = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, l = CKEDITOR.dom.walker.editable(), u = CKEDITOR.dom.walker.ignored(!0); CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                } var c = this.startContainer, d = this.endContainer, f = this.collapsed, h, n, g, k; h = this.document.createElement("span"); h.data("cke-bookmark", 1); h.setStyle("display", "none"); h.setHtml("\x26nbsp;"); a && (g = "cke_bm_" + CKEDITOR.tools.getNextNumber(), h.setAttribute("id", g + (f ? "C" : "S"))); f || (n = h.clone(), n.setHtml("\x26nbsp;"), a && n.setAttribute("id", g + "E"), k = this.clone(), b(d) && (d = b(d),
                    k.moveToPosition(d, CKEDITOR.POSITION_AFTER_END)), k.collapse(), k.insertNode(n)); k = this.clone(); b(c) && (d = b(c), k.moveToPosition(d, CKEDITOR.POSITION_BEFORE_START)); k.collapse(!0); k.insertNode(h); n ? (this.setStartAfter(h), this.setEndBefore(n)) : this.moveToPosition(h, CKEDITOR.POSITION_AFTER_END); return { startNode: a ? g + (f ? "C" : "S") : h, endNode: a ? g + "E" : n, serializable: a, collapsed: f }
            }, createBookmark2: function () {
                function a(b) {
                    var e = b.container, d = b.offset, n; n = e; var f = d; n = n.type != CKEDITOR.NODE_ELEMENT || 0 === f || f == n.getChildCount() ?
                        0 : n.getChild(f - 1).type == CKEDITOR.NODE_TEXT && n.getChild(f).type == CKEDITOR.NODE_TEXT; n && (e = e.getChild(d - 1), d = e.getLength()); if (e.type == CKEDITOR.NODE_ELEMENT && 0 < d) { a: { for (n = e; d--;)if (f = n.getChild(d).getIndex(!0), 0 <= f) { d = f; break a } d = -1 } d += 1 } if (e.type == CKEDITOR.NODE_TEXT) {
                            n = e; for (f = 0; (n = n.getPrevious()) && n.type == CKEDITOR.NODE_TEXT;)f += n.getText().replace(CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE, "").length; n = f; e.isEmpty() ? (f = e.getPrevious(c), n ? (d = n, e = f ? f.getNext() : e.getParent().getFirst()) : (e = e.getParent(),
                ...
                function c(a) { return a && a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") ? null : a } var d = new RegExp(/[^\s\ufeff]/); switch (a) {
                    case CKEDITOR.ENLARGE_INLINE: var f = 1; case CKEDITOR.ENLARGE_ELEMENT: var h = function (a, b) {
                        var c = new CKEDITOR.dom.range(g); c.setStart(a, b); c.setEndAt(g, CKEDITOR.POSITION_BEFORE_END); var c = new CKEDITOR.dom.walker(c), e; for (c.guard =
                            function (a) { return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()) }; e = c.next();) { if (e.type != CKEDITOR.NODE_TEXT) return !1; M = e != a ? e.getText() : e.substring(b); if (d.test(M)) return !1 } return !0
                    }; if (this.collapsed) break; var n = this.getCommonAncestor(), g = this.root, k, u, l, m, C, K = !1, A, M; A = this.startContainer; var r = this.startOffset; A.type == CKEDITOR.NODE_TEXT ? (r && (A = !CKEDITOR.tools.trim(A.substring(0, r)).length && A, K = !!A), A && ((m = A.getPrevious()) || (l = A.getParent()))) : (r && (m = A.getChild(r - 1) || A.getLast()), m || (l = A));
                        for (l = c(l); l || m;) {
                            if (l && !m) { !C && l.equals(n) && (C = !0); if (f ? l.isBlockBoundary() : !g.contains(l)) break; K && "inline" == l.getComputedStyle("display") || (K = !1, C ? k = l : this.setStartBefore(l)); m = l.getPrevious() } for (; m;)if (A = !1, m.type == CKEDITOR.NODE_COMMENT) m = m.getPrevious(); else {
                                if (m.type == CKEDITOR.NODE_TEXT) M = m.getText(), d.test(M) && (m = null), A = /[\s\ufeff]$/.test(M); else if ((m.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && m.is("br")) && !m.data("cke-bookmark")) if (K && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                    M = m.getText();
                                    if (d.test(M)) m = null; else for (var r = m.$.getElementsByTagName("*"), D = 0, B; B = r[D++];)if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) { m = null; break } m && (A = !!M.length)
                            ...
                            h(A, r) && (l = A.getParent())) : (m = A.getChild(r)) || (l = A); for (; l || m;) {
                                if (l && !m) { !C && l.equals(n) && (C = !0); if (f ? l.isBlockBoundary() : !g.contains(l)) break; K && "inline" == l.getComputedStyle("display") || (K = !1, C ? u = l : l && this.setEndAfter(l)); m = l.getNext() } for (; m;) {
                                    A = !1; if (m.type == CKEDITOR.NODE_TEXT) M = m.getText(), h(m, 0) || (m = null), A = /^[\s\ufeff]/.test(M); else if (m.type == CKEDITOR.NODE_ELEMENT) {
                                        if ((0 < m.$.offsetWidth || b && m.is("br")) && !m.data("cke-bookmark")) if (K && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                            M = m.getText(); if (d.test(M)) m =
                                                null; else for (r = m.$.getElementsByTagName("*"), D = 0; B = r[D++];)if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) { m = null; break } m && (A = !!M.length)
                                        } else m = null
                                    } else A = 1; A && K && (C ? u = l : this.setEndAfter(l)); if (m) { A = m.getNext(); if (!l && !A) { l = m; m = null; break } m = A } else l = null
                                } l && (l = c(l.getParent()))
                            } k && u && (n = k.contains(u) ? u : k, this.setStartBefore(n), this.setEndAfter(n)); break; case CKEDITOR.ENLARGE_BLOCK_CONTENTS: case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS: l = new CKEDITOR.dom.range(this.root); g = this.root; l.setStartAt(g,
                                CKEDITOR.POSITION_AFTER_START); l.setEnd(this.startContainer, this.startOffset); l = new CKEDITOR.dom.walker(l); var v, S, R = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null), p = null, N = function (a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable")) if (p) { if (p.equals(a)) { p = null; return } } else p = a; else if (p) return; var b = R(a); b || (v = a); return b }, f = function (a) { var b = N(a); !b && a.is && a.is("br") && (S = a); return b }; l.guard = N; l = l.lastBackward(); v = v || g; this.setStartAt(v,
                                    !v.is("br") && (!l && this.checkStartOfBlock() || l && v.contains(l)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END); if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { l = this.clone(); l = new CKEDITOR.dom.walker(l); var O = CKEDITOR.dom.walker.whitespaces(), q = CKEDITOR.dom.walker.bookmark(); l.evaluator = function (a) { return !O(a) && !q(a) }; if ((l = l.previous()) && l.type == CKEDITOR.NODE_ELEMENT && l.is("br")) break } l = this.clone(); l.collapse(); l.setEndAt(g, CKEDITOR.POSITION_BEFORE_END); l = new CKEDITOR.dom.walker(l); l.guard =
                                        a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? f : N; v = p = S = null; l = l.lastForward(); v = v || g; this.setEndAt(v, !l && this.checkEndOfBlock() || l && v.contains(l) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START); S && this.setEndAfter(S)
                }
                ...
                var d = "boolean" === typeof c ? c : c && "boolean" === typeof c.shrinkOnBlockBoundary ? c.shrinkOnBlockBoundary : !0, f = c && c.skipBogus; if (!this.collapsed) {
                    a = a || CKEDITOR.SHRINK_TEXT; var h = this.clone(), n = this.startContainer, g = this.endContainer, k = this.startOffset, l = this.endOffset,
                        u = c = 1; n && n.type == CKEDITOR.NODE_TEXT && (k ? k >= n.getLength() ? h.setStartAfter(n) : (h.setStartBefore(n), c = 0) : h.setStartBefore(n)); g && g.type == CKEDITOR.NODE_TEXT && (l ? l >= g.getLength() ? h.setEndAfter(g) : (h.setEndAfter(g), u = 0) : h.setEndBefore(g)); var h = new CKEDITOR.dom.walker(h), m = CKEDITOR.dom.walker.bookmark(), C = CKEDITOR.dom.walker.bogus(); h.evaluator = function (b) { return b.type == (a == CKEDITOR.SHRINK_ELEMENT ? CKEDITOR.NODE_ELEMENT : CKEDITOR.NODE_TEXT) }; var K; h.guard = function (b, c) {
                            if (f && C(b) || m(b)) return !0; if (a == CKEDITOR.SHRINK_ELEMENT &&
                ...
                b) { var c = this.createBookmark(), d = this.document.createElement(b); this.collapse(a); this.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS); this.extractContents().appendTo(d); d.trim(); this.insertNode(d); var f = d.getBogus(); f && f.remove(); d.appendBogus(); this.moveToBookmark(c); return d }, splitBlock: function (a, b) {
                    var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root), d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), f = c.block, h = d.block, n = null; if (!c.blockLimit.equals(d.blockLimit)) return null; "br" !=
                        a && (f || (f = this.fixBlock(!0, a), h = (new CKEDITOR.dom.elementPath(this.endContainer, this.root)).block), h || (h = this.fixBlock(!1, a))); c = f && this.checkStartOfBlock(); d = h && this.checkEndOfBlock(); this.deleteContents(); f && f.equals(h) && (d ? (n = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(h, CKEDITOR.POSITION_AFTER_END), h = null) : c ? (n = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f = null) : (h = this.splitElement(f, b ||
                            !1), f.is("ul", "ol") || f.appendBogus())); return { previousBlock: f, nextBlock: h, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: n }
                    ...
                    var c, d = 0, f, h, n = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START]; a ? (c = new CKEDITOR.dom.range(this.root), c.moveToPosition(a, n[b ? 0 : 1])) : c = this.clone(); if (a &&
            ...
            moveToElementEditEnd: function (a) { return this.moveToElementEditablePosition(a, !0) }, getEnclosedNode: function () { var a = this.clone(); a.optimize(); if (a.startContainer.type != CKEDITOR.NODE_ELEMENT || a.endContainer.type != CKEDITOR.NODE_ELEMENT) return null; var a = new CKEDITOR.dom.walker(a), b = CKEDITOR.dom.walker.bookmark(!1, !0), c = CKEDITOR.dom.walker.whitespaces(!0); a.evaluator = function (a) { return c(a) && b(a) }; var d = a.next(); a.reset(); return d && d.equals(a.previous()) ? d : null }, getTouchedStartNode: function () {
                ...
                function a(b, c) {
                    ...
                    var f = this.root.getDocument().$.createRange(), n; f.setStart(this.startContainer.$, this.startOffset); f.setEnd(this.endContainer.$, this.endOffset); n = f.getClientRects(); n = a(n, this); n.length || (n = b(n, f, this)); return CKEDITOR.tools.array.map(n, function (a) {
                        return c(a,
                            d, this)
                    }, this)
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), f = [], h, n, g, k; if (c && c.find) for (n = c.find(a), h = 0; h < n.count(); h++)if (c = n.getItem(h), b || !c.isReadOnly()) g = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), k = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
        ...
        function a(a) { 1 > arguments.length || (this.range = a, this.forceBrBreak = 0, this.enlargeBr = 1, this.enforceRealBlocks = 0, this._ || (this._ = {})) } function d(a) { var b = []; a.forEach(function (a) { if ("true" == a.getAttribute("contenteditable")) return b.push(a), !1 }, CKEDITOR.NODE_ELEMENT, !0); return b } function b(a, c, f, h) {
            ...
            g = function (a) { return h(a) && k(a) }, l = { dd: 1, dt: 1, li: 1 }; a.prototype = {
                getNextParagraph: function (a) {
                    var d, k, w, z, H; a = a || "p"; if (this._.nestedEditable) {
                        ...
                        t.collapsed || (k = new CKEDITOR.dom.walker(t.clone()), n = CKEDITOR.dom.walker.bookmark(!0, !0), k.evaluator = n, this._.nextNode = k.next(), k = new CKEDITOR.dom.walker(t.clone()), k.evaluator = n, k = k.previous(), this._.lastNode = k.getNextSourceNode(!0, null, t.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (n = this.range.clone(), n.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), n.checkEndOfBlock() &&
                            (n = new CKEDITOR.dom.elementPath(n.endContainer, n.root), this._.lastNode = (n.block || n.blockLimit).getNextSourceNode(!0))), this._.lastNode && t.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = t.document.createText(""), this._.lastNode.insertAfter(k)), t = null); this._.started = 1; k = t
                    } n = this._.nextNode; t = this._.lastNode; for (this._.nextNode = null; n;) {
                        var L = 0, y = n.hasAscendant("pre"), F = n.type != CKEDITOR.NODE_ELEMENT, I = 0; if (F) n.type == CKEDITOR.NODE_TEXT && f.test(n.getText()) && (F = 0); else {
                            var m = n.getName();
                            if (CKEDITOR.dtd.$block[m] && "false" == n.getAttribute("contenteditable")) { d = n; b(this, a, d); break } else if (n.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) { if ("br" == m) F = 1; else if (!k && !n.getChildCount() && "hr" != m) { d = n; w = n.equals(t); break } k && (k.setEndAt(n, CKEDITOR.POSITION_BEFORE_START), "br" != m && (this._.nextNode = n)); L = 1 } else { if (n.getFirst()) { k || (k = this.range.clone(), k.setStartAt(n, CKEDITOR.POSITION_BEFORE_START)); n = n.getFirst(); continue } F = 1 }
                        } F && !k && (k = this.range.clone(), k.setStartAt(n, CKEDITOR.POSITION_BEFORE_START));
                        w = (!L || F) && n.equals(t); if (k && !L) for (; !n.getNext(g) && !w;) { m = n.getParent(); if (m.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) { L = 1; F = 0; w || m.equals(t); k.setEndAt(m, CKEDITOR.POSITION_BEFORE_END); break } n = m; F = 1; w = n.equals(t); I = 1 } F && k.setEndAt(n, CKEDITOR.POSITION_AFTER_END); n = this._getNextSourceNode(n, I, t); if ((w = !n) || L && k) break
                    } if (!d) {
                        if (!k) return this._.docEndMarker && this._.docEndMarker.remove(), this._.nextNode = null; d = new CKEDITOR.dom.elementPath(k.startContainer, k.root); n = d.blockLimit; L = { div: 1, th: 1, td: 1 };
    ...
    (function () {
        function a(a, b, c, d, e) {
            var f, m; a = []; for (f in b) {
                m = b[f]; m = "boolean" == typeof m ? {} : "function" == typeof m ? { match: m } : D(m); "$" != f.charAt(0) && (m.elements = f); c && (m.featureName = c.toLowerCase()); var q = m; q.elements = k(q.elements, /\s+/) || null; q.propertiesOnly = q.propertiesOnly || !0 === q.elements; var r = /\s*,\s*/, B = void 0; for (B in S) {
                    q[B] = k(q[B], r) || null; var h = q, p = R[B], n = k(q[R[B]], r), g = q[B], v = [], G = !0, N = void 0; n ? G = !1 : n = {}; for (N in g) "!" == N.charAt(0) && (N = N.slice(1), v.push(N), n[N] = !0, G = !1); for (; N = v.pop();)g[N] =
                        g["!" + N], delete g["!" + N]; h[p] = (G ? !1 : n) || null
                } q.match = q.match || null; d.push(m); a.push(m)
            } b = e.elements; e = e.generic; var C; c = 0; for (d = a.length; c < d; ++c) {
                f = D(a[c]); m = !0 === f.classes || !0 === f.styles || !0 === f.attributes; q = f; B = p = r = void 0; for (r in S) q[r] = L(q[r]); h = !0; for (B in R) { r = R[B]; p = q[r]; n = []; g = void 0; for (g in p) -1 < g.indexOf("*") ? n.push(new RegExp("^" + g.replace(/\*/g, ".*") + "$")) : n.push(g); p = n; p.length && (q[r] = p, h = !1) } q.nothingRequired = h; q.noProperties = !(q.attributes || q.classes || q.styles); if (!0 === f.elements ||
                    null === f.elements) e[m ? "unshift" : "push"](f); else for (C in q = f.elements, delete f.elements, q) if (b[C]) b[C][m ? "unshift" : "push"](f); else b[C] = [f]
            }
        } function d(a, c, d, e) {
            ...
            b) { if (!a) return !1; var c = !1, d = !0 === a, e; for (e in b) if (d || a(e)) delete b[e], c = !0; return c } function h(a, b, c) { if (a.disabled || a.customConfig && !c || !b) return !1; a._.cachedChecks = {}; return !0 } function k(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = B(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {}, d = 0, e; for (e in a) c[e] = a[e], d++; return d ? c : !1 } function g(a, b) {
            ...
            } function e(a) { var b, c, d, e, f = {}, m = 1; for (a = B(a); b = a.match(p);)(c = b[2]) ? (d = x(c, "styles"), e = x(c, "attrs"), c = x(c, "classes")) : d = e = c = null, f["$" + m++] = { elements: b[1], classes: c, styles: d, attributes: e }, a = a.slice(b[0].length); return f } function x(a, b) { var c = a.match(N[b]); return c ? B(c[1]) : null } function w(a) {
                ...
                var r = 0, B; f.toHtml && (b.name = b.name.replace(O, "$1")); if (f.doCallbacks && a.elementCallbacks) { a: { B = a.elementCallbacks; for (var p = 0, h = B.length, g; p < h; ++p)if (g = B[p](b)) { B = g; break a } B = void 0 } if (B) return B } if (f.doTransform && (B = a._.transformations[b.name])) { w(b); for (p = 0; p < B.length; ++p)m(a, b, B[p]); t(b) } if (f.doFilter) {
                    a: {
                        p = b.name; h = a._; a = h.allowedRules.elements[p]; B = h.allowedRules.generic; p = h.disallowedRules.elements[p]; h = h.disallowedRules.generic;
                    ...
                    } if (!a || !a.valid) return e.push(b), 1; D = a.validAttributes; var N = a.validStyles;
                    B = a.validClasses; var p = b.attributes, G = b.styles, h = b.classes; g = b.classBackup; var C = b.styleBackup, A, K, l = [], k = [], M = /^data-cke-/; v = !1; delete p.style; delete p["class"]; delete b.classBackup; delete b.styleBackup; if (!a.allAttributes) for (A in p) D[A] || (M.test(A) ? A == (K = A.replace(/^data-cke-saved-/, "")) || D[K] || (delete p[A], v = !0) : (delete p[A], v = !0)); if (!a.allStyles || a.hadInvalidStyle) { for (A in G) a.allStyles || N[A] ? l.push(A + ":" + G[A]) : v = !0; l.length && (p.style = l.sort().join("; ")) } else C && (p.style = C); if (!a.allClasses ||
                        a.hadInvalidClass) { for (A = 0; A < h.length; ++A)(a.allClasses || B[h[A]]) && k.push(h[A]); k.length && (p["class"] = k.sort().join(" ")); g && k.length < g.split(/\s+/).length && (v = !0) } else g && (p["class"] = g); v && (r = 1); if (!f.skipFinalValidation && !n(b)) return e.push(b), 1
                } f.toHtml && (b.name = b.name.replace(q, "cke:$1")); return r
            } function H(a) { var b = [], c; for (c in a) -1 < c.indexOf("*") && b.push(c.replace(/\*/g, ".*")); return b.length ? new RegExp("^(?:" + b.join("|") + ")$") : null } function t(a) {
                ...
                var c = b.getDefinition(), d = c.attributes, e = c.styles, f, m, q, p; if (a.name != c.element) return !1; for (f in d) if ("class" == f) for (c = d[f].split(/\s+/), q = a.classes.join("|"); p = c.pop();) { if (-1 == q.indexOf(p)) return !1 } else if (a.attributes[f] != d[f]) return !1; for (m in e) if (a.styles[m] !=
                ...
                allow: function (b, c, d) {
                    if (!h(this, b, d)) return !1; var f, m; if ("string" == typeof b) b = e(b); else if (b instanceof CKEDITOR.style) {
                    ...
                    a.forEach(function (a) {
                        if (a.type == CKEDITOR.NODE_ELEMENT) { if ("off" == a.attributes["data-cke-filter"]) return !1; if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-")) if (q = z(e, a, f, B), q & 1) p = !0; else if (q & 2) return !1 } else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                            var c; a: {
                                var d = decodeURIComponent(a.value.replace(/^\{cke_protected\}/, "")); c = []; var h, r, n; if (m) for (r = 0; r < m.length; ++r)if ((n = d.match(m[r])) && n[0].length == d.length) {
                                    c =
                                    !0; break a
                                } d = CKEDITOR.htmlParser.fragment.fromHtml(d); 1 == d.children.length && (h = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(e, h, c, B); c = !c.length
                            } c || f.push(a)
                        }
                    }, null, !0); f.length && (p = !0); var h; a = []; d = v[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; for (var g; c = f.pop();)c.type == CKEDITOR.NODE_ELEMENT ? I(c, d, a) : c.remove(); for (; h = a.pop();)if (c = h.el, c.parent) switch (g = r[c.parent.name] || r.span, h.check) {
                        case "it": r.$removeEmpty[c.name] && !c.children.length ? I(c, d, a) : n(c) || I(c, d, a); break; case "el-up": c.parent.type ==
                            CKEDITOR.NODE_DOCUMENT_FRAGMENT || g[c.name] || I(c, d, a); break; case "parent-down": c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || g[c.name] || I(c.parent, d, a)
                    }return p
                ...
                addContentForms: function (a) { if (!this.disabled && a) { var b, c, d = [], e; for (b = 0; b < a.length && !e; ++b)c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (e = c); if (e) { for (b = 0; b < a.length; ++b)d.push(K(a[b], e)); this.addTransformations(d) } } }, addElementCallback: function (a) { this.elementCallbacks || (this.elementCallbacks = []); this.elementCallbacks.push(a) }, addFeature: function (a) {
                    ...
                    var b, c; if (!this.disabled && a) {
                        var d = this._.transformations, e; for (e = 0; e < a.length; ++e) {
                            b = a[e]; var f = void 0, m = void 0, q = void 0, p = void 0, B = void 0, h = void 0; c = []; for (m = 0; m < b.length; ++m)q = b[m], "string" == typeof q ? (q = q.split(/\s*:\s*/), p = q[0], B = null, h = q[1]) : (p = q.check, B = q.left, h = q.right), f || (f = q, f = f.element ? f.element : p ? p.match(/^([a-z0-9]+)/i)[0] :
                                f.left.getDefinition().element), B instanceof CKEDITOR.style && (B = A(B)), c.push({ check: p == f ? null : p, left: B, right: "string" == typeof h ? M(h) : h }); b = f; d[b] || (d[b] = []); d[b].push(c)
                        }
                    }
                }, check: function (a, b, c) {
                    if (this.disabled) return !0; if (CKEDITOR.tools.isArray(a)) { for (var d = a.length; d--;)if (this.check(a[d], b, c)) return !0; return !1 } var f, q; if ("string" == typeof a) {
                        q = a + "\x3c" + (!1 === b ? "0" : "1") + (c ? "1" : "0") + "\x3e"; if (q in this._.cachedChecks) return this._.cachedChecks[q]; f = e(a).$1; var p = f.styles, d = f.classes; f.name = f.elements;
                        f.classes = d = d ? d.split(/\s*,\s*/) : []; f.styles = u(p); f.attributes = u(f.attributes); f.children = []; d.length && (f.attributes["class"] = d.join(" ")); p && (f.attributes.style = CKEDITOR.tools.writeCssText(f.styles))
                    } else f = a.getDefinition(), p = f.styles, d = f.attributes || {}, p && !CKEDITOR.tools.isEmpty(p) ? (p = D(p), d.style = CKEDITOR.tools.writeCssText(p, !0)) : p = {}, f = { name: f.element, attributes: d, classes: d["class"] ? d["class"].split(/\s+/) : [], styles: p, children: [] }; var p = CKEDITOR.tools.clone(f), B = [], h; if (!1 !== b && (h = this._.transformations[f.name])) {
                        for (d =
                            0; d < h.length; ++d)m(this, f, h[d]); t(f)
                    } z(this, p, B, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c }); 0 < B.length ? c = !1 : ((b = f.attributes["class"]) && (f.attributes["class"] = f.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(f.attributes, p.attributes, !0), b && (f.attributes["class"] = b)); "string" == typeof a && (this._.cachedChecks[q] = c); return c
            ...
            }; var S = { styles: 1, attributes: 1, classes: 1 }, R = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" }, p = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, N = { styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/ }, O = /^cke:(object|embed|param)$/, q = /^(object|embed|param)$/, G; G = CKEDITOR.filter.transformationsTools = {
                sizeToStyle: function (a) {
                    ...
                    if ("string" == typeof b) a.name = b; else {
                        var c = b.getDefinition(), d = c.styles, f = c.attributes, e, m, q, p; a.name = c.element; for (e in f) if ("class" == e) for (c =
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) { if (this.registered[a]) throw Error('[CKEDITOR.resourceManager.add] The resource name "' + a + '" is already registered.'); var b = this.registered[a] = d || {}; b.name = a; b.path = this.getPath(a); CKEDITOR.fire(a + CKEDITOR.tools.capitalize(this.fileName) + "Ready", b); return this.get(a) }, get: function (a) { return this.registered[a] || null }, getPath: function (a) { var d = this.externals[a]; return CKEDITOR.getUrl(d && d.dir || this.basePath + a + "/") }, getFilePath: function (a) {
            ...
            CKEDITOR.tools.isArray(a) || (a = a ? [a] : []); for (var c = this.loaded, f = this.registered, h = [], k = {}, g = {}, l = 0; l < a.length; l++) { var u = a[l]; if (u) if (c[u] || f[u]) g[u] = this.get(u); else { var e = this.getFilePath(u); h.push(e); e in k || (k[e] = []); k[e].push(u) } } CKEDITOR.scriptLoader.load(h,
                function (a, e) { if (e.length) throw Error('[CKEDITOR.resourceManager.load] Resource name "' + k[e[0]].join(",") + '" was not found at "' + e[0] + '".'); for (var f = 0; f < a.length; f++)for (var h = k[a[f]], l = 0; l < h.length; l++) { var n = h[l]; g[n] = this.get(n); c[n] = 1 } d.call(b, g) }, this)
        }
            ...
            var h = {}, k = function (b) {
                a.call(this, b, function (a) {
                    CKEDITOR.tools.extend(h, a); var b = [], e; for (e in a) {
                        var g = a[e], w = g && g.requires; if (!d[e]) { if (g.icons) for (var z = g.icons.split(","), H = z.length; H--;)CKEDITOR.skin.addIcon(z[H], g.path + "icons/" + (CKEDITOR.env.hidpi && g.hidpi ? "hidpi/" : "") + z[H] + ".png"); g.isSupportedEnvironment = g.isSupportedEnvironment || function () { return !0 }; d[e] = 1 } if (w) for (w.split && (w =
    ...
    (function () {
        ...
        } function d() { do var a = "editor" + ++H; while (CKEDITOR.instances[a]); return a } function b(a, b) { return b == CKEDITOR.ELEMENT_MODE_INLINE ? a.is(CKEDITOR.dtd.$editable) || a.is("textarea") : b == CKEDITOR.ELEMENT_MODE_REPLACE ? !a.is(CKEDITOR.dtd.$nonBodyContent) : 1 } function c() { var a = this.commands, b; for (b in a) f(this, a[b]) } function f(a, b) {
                ...
                function (b) {
                    var d = [], e = [], f = []; a.plugins = CKEDITOR.tools.extend({}, a.plugins, b); for (var m in b) {
                        var h = b[m], k = h.lang, C = null, p = h.requires, N; CKEDITOR.tools.isArray(p) && (p = p.join(",")); if (p && (N = p.match(g))) for (; p = N.pop();)CKEDITOR.error("editor-plugin-required", { plugin: p.replace(",", ""), requiredBy: m }); k && !a.lang[m] && (k.split && (k = k.split(",")), 0 <= CKEDITOR.tools.indexOf(k, a.langCode) ? C = a.langCode : (C = a.langCode.replace(/-.*/, ""), C = C != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, C) ? C : 0 <= CKEDITOR.tools.indexOf(k,
                            "en") ? "en" : k[0]), h.langEntries && h.langEntries[C] ? (a.lang[m] = h.langEntries[C], C = null) : f.push(CKEDITOR.getUrl(h.path + "lang/" + C + ".js"))); e.push(C); d.push(h)
                    } CKEDITOR.scriptLoader.load(f, function () {
                        if (!a.isDestroyed() && !a.isDetached()) {
                            for (var b = ["beforeInit", "init", "afterInit"], f = 0; f < b.length; f++)for (var m = 0; m < d.length; m++) { var p = d[m]; 0 === f && e[m] && p.lang && p.langEntries && (a.lang[p.name] = p.langEntries[e[m]]); if (p[b[f]]) p[b[f]](a) } a.fireOnce("pluginsLoaded"); c.keystrokes && a.setKeystroke(a.config.keystrokes);
                            for (m = 0; m < a.config.blockedKeystrokes.length; m++)a.keystrokeHandler.blockedKeystrokes[a.config.blockedKeystrokes[m]] = 1; a.status = "loaded"; a.fireOnce("loaded"); CKEDITOR.fire("instanceLoaded", null, a)
                        }
                    })
                })
        } function w() { var a = this.element; if (a && this.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO) { var b = this.getData(); this.config.htmlEncodeOutput && (b = CKEDITOR.tools.htmlEncode(b)); a.is("textarea") ? a.setValue(b) : a.setHtml(b); return !0 } return !1 } function z(a, b) {
            function c(a) {
                ...
                var l = a[k], r = l.startContainer.getAscendant("tr", !0); c(l) ? (f || (f = r.getAscendant("table").clone(), f.append(r.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()), e.append(f), f = f.findOne("thead, tbody, tfoot")), h && h.equals(r) || (h = r, g = r.clone(), f.append(g)), g.append(d(l))) :
                    e.append(l.cloneContents())
            } return f ? e : b.getHtmlFromRange(a[0])
        } a.prototype = CKEDITOR.editor.prototype; CKEDITOR.editor = a; var H = 0, t = {}; CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
    ...
    (function () {
        function a(a) { return a.attributes["data-cke-survive"] ? !1 : "a" == a.name && a.attributes.href || CKEDITOR.dtd.$removeEmpty[a.name] } var d = CKEDITOR.tools.extend({ table: 1, ul: 1, ol: 1, dl: 1 }, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = { ol: 1, ul: 1 }, c = CKEDITOR.tools.extend({}, { html: 1 }, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, { style: 1, script: 1 }), f = { ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td" }; CKEDITOR.htmlParser.fragment.fromHtml =
            function (h, k, g) {
                function l(a) { var b; if (0 < n.length) for (var c = 0; c < n.length; c++) { var d = n[c], e = d.name, f = CKEDITOR.dtd[e], h = y.name && CKEDITOR.dtd[y.name]; h && !h[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == y.name && (x(y, y.parent, 1), c--) : (b || (u(), b = 1), d = d.clone(), d.parent = y, y = d, n.splice(c, 1), c--) } } function u() { for (; L.length;)x(L.shift(), y) } function e(a) {
                ...
                } function x(b, c, d) { c = c || y || t; var f = y; void 0 === b.previous && (w(c, b) && (y = c, H.onTagOpen(g, {}), b.returnPoint = c = y), e(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (I = !1), "textarea" == b.name && (F = !1)); b.returnPoint ? (y = b.returnPoint, delete b.returnPoint) : y = d ? c : f } function w(a, b) {
                    if ((a == t || "body" == a.name) && g && (!a.name || CKEDITOR.dtd[a.name][g])) {
                ...
                } function z(a, b) { return a in CKEDITOR.dtd.$listItem || a in CKEDITOR.dtd.$tableContent ? a == b || "dt" == a && "dd" == b || "dd" == a && "dt" == b : !1 } var H = new CKEDITOR.htmlParser, t = k instanceof CKEDITOR.htmlParser.element ? k : "string" == typeof k ? new CKEDITOR.htmlParser.element(k) : new CKEDITOR.htmlParser.fragment, n = [], L = [], y = t, F = "textarea" == t.name, I = "pre" == t.name; H.onTagOpen = function (e, f, h, g) {
                    f = new CKEDITOR.htmlParser.element(e, f); f.isUnknown && h && (f.isEmpty = !0); f.isOptionalClose = g;
                    if (a(f)) n.push(f); else {
                        if ("pre" == e) I = !0; else { if ("br" == e && I) { y.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (F = !0) } if ("br" == e) L.push(f); else {
                            for (; !(g = (h = y.name) ? CKEDITOR.dtd[h] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || y.isUnknown || g[e]);)if (y.isOptionalClose) H.onTagClose(h); else if (e in b && h in b) h = y.children, (h = h[h.length - 1]) && "li" == h.name || x(h = new CKEDITOR.htmlParser.element("li"), y), !f.returnPoint && (f.returnPoint = y), y = h; else if (e in CKEDITOR.dtd.$listItem &&
                                !z(e, h)) H.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (h in d && !z(e, h)) !f.returnPoint && (f.returnPoint = y), y = y.parent; else if (h in CKEDITOR.dtd.$inline && n.unshift(y), y.parent) x(y, y.parent, 1); else { f.isOrphan = 1; break } l(e); u(); f.parent = y; f.isEmpty ? x(f) : y = f
                        }
                    }
                }; H.onTagClose = function (a) {
                    for (var b = n.length - 1; 0 <= b; b--)if (a == n[b].name) { n.splice(b, 1); return } for (var c = [], d = [], e = y; e != t && e.name != a;)e._.isBlockLike || d.unshift(e), c.push(e), e = e.returnPoint || e.parent; if (e != t) {
                        for (b = 0; b < c.length; b++) { var f = c[b]; x(f, f.parent) } y =
                            e; e._.isBlockLike && u(); x(e, e.parent); e == y && (y = y.parent); n = n.concat(d)
                    } "body" == a && (g = !1)
                }; H.onText = function (a) { if (!(y._.hasInlineStarted && !L.length || I || F) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = y.name, e = b ? CKEDITOR.dtd[b] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!F && !e["#"] && b in d) H.onTagOpen(f[b] || ""), H.onText(a); else { u(); l(); I || F || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " ")); a = new CKEDITOR.htmlParser.text(a); if (w(y, a)) this.onTagOpen(g, {}, 0, 1); y.add(a) } }; H.onCDATA =
                    function (a) { y.add(new CKEDITOR.htmlParser.cdata(a)) }; H.onComment = function (a) { u(); l(); y.add(new CKEDITOR.htmlParser.comment(a)) }; H.parse(h); for (u(); y != t;)x(y, y.parent, 1); e(t); return t
    ...
    (function () {
        function a(a, d) {
            function e(a) { return a || CKEDITOR.env.needsNbspFiller ? new CKEDITOR.htmlParser.text(" ") : new CKEDITOR.htmlParser.element("br", { "data-cke-bogus": 1 }) } function p(a, d) {
                return function (f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var q = [], p = b(f), m, r; if (p) for (B(p, 1) && q.push(p); p;)h(p) && (m = c(p)) && B(m) && ((r = c(m)) && !h(r) ? q.push(m) : (e(g).insertAfter(m), m.remove())), p = p.previous; for (p = 0; p < q.length; p++)q[p].remove(); if (q = !a || !1 !== ("function" == typeof d ? d(f) : d)) g || CKEDITOR.env.needsBrFiller ||
                            f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? g || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem) ? (q = b(f), q = !q || "form" == f.name && "input" == q.name) : q = !1 : q = !1; q && f.add(e(a))
                    }
                }
            } function B(a, b) {
                if ((!g || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT && "br" == a.name && !a.attributes["data-cke-eol"]) return !0; var c; return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(L)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a),
                    a.value = c[0]), !CKEDITOR.env.needsBrFiller && g && (!b || a.parent.name in v) || !g && ((c = a.previous) && "br" == c.name || !c || h(c))) ? !0 : !1
            } var r = { elements: {} }, g = "html" == d, v = CKEDITOR.tools.extend({}, m), D; for (D in v) "#" in F[D] || delete v[D]; for (D in v) r.elements[D] = p(g, a.config.fillEmptyBlocks); r.root = p(g, !1); r.elements.br = function (a) {
                return function (b) {
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var d = b.attributes; if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"]; else {
                            for (d = b.next; d && f(d);)d =
                                d.next; var q = c(b); !d && h(b.parent) ? k(b.parent, e(a)) : h(d) && q && !h(q) && e(a).insertBefore(d)
                        }
                    }
                }
            }(g); return r
            ...
            return a.replace(r,
                function (a, b, c) { return "\x3c" + b + c.replace(D, function (a, b) { return B.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a }) + "\x3e" })
        } function e(a, b) { return a.replace(b, function (a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + z(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) } function x(a) { return a.replace(R, function (a, b) { return decodeURIComponent(b) }) } function w(a) {
            return a.replace(/\x3c!--(?!{cke_protected})[\s\S]+?--\x3e/g,
                function (a) { return "\x3c!--" + y + "{C}" + encodeURIComponent(a).replace(/--/g, "%2D%2D") + "--\x3e" })
        } function z(a) { return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }) } function H(a, b) { var c = b._.dataStore; return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }).replace(/\{cke_protected_(\d+)\}/g, function (a, b) { return c && c[b] || "" }) } function t(a, b) {
            var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore =
                ...
                }); a = a.replace(/<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g, function (a) { return a.replace(/\x3c!--\{cke_protected\}([^>]*)--\x3e/g, function (a, b) { e[e.id] = decodeURIComponent(b); return "{cke_protected_" + e.id++ + "}" }) }); return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, e) { return "\x3c" + c + d + "\x3e" + H(z(e), b) + "\x3c/" + c + "\x3e" })
            ...
            f, m = this; this.editor = b; this.dataFilter = c = new CKEDITOR.htmlParser.filter; this.htmlFilter = f = new CKEDITOR.htmlParser.filter; this.writer = new CKEDITOR.htmlParser.basicWriter; c.addRules(C); c.addRules(K, { applyToAll: !0 }); c.addRules(a(b, "data"), { applyToAll: !0 }); f.addRules(A); f.addRules(M, { applyToAll: !0 }); f.addRules(a(b, "html"), { applyToAll: !0 }); b.on("toHtml", function (a) {
                a = a.data; var c = a.dataValue, f, c = n(c), c = t(c, b), c = e(c, S), c = u(c), c = e(c, v), c = c.replace(p, "$1cke:$2"), c = c.replace(O, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
                    c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), c = c.replace(/([^a-z0-9<\-])(on\w{3,})(?!>)/gi, "$1data-cke-" + CKEDITOR.rnd + "-$2"); f = a.context || b.editable().getName(); var m; CKEDITOR.env.ie && 9 > CKEDITOR.env.version && "pre" == f && (f = "div", c = "\x3cpre\x3e" + c + "\x3c/pre\x3e", m = 1); f = b.document.createElement(f); f.setHtml("a" + c); c = f.getHtml().substr(1); c = c.replace(new RegExp("data-cke-" + CKEDITOR.rnd + "-", "ig"), ""); m && (c = c.replace(/^<pre>|<\/pre>$/gi, "")); c = c.replace(N, "$1$2"); c = x(c); c = z(c); f = !1 === a.fixForBody ? !1 :
                        d(a.enterMode, b.config.autoParagraph); c = CKEDITOR.htmlParser.fragment.fromHtml(c, a.context, f); f && (m = c, !m.children.length && CKEDITOR.dtd[m.name][f] && (f = new CKEDITOR.htmlParser.element(f), m.add(f))); a.dataValue = c
            }, null, null, 5); b.on("toHtml", function (a) { a.data.filter.applyTo(a.data.dataValue, !0, a.data.dontFilter, a.data.enterMode) && b.fire("dataFiltered") }, null, null, 6); b.on("toHtml", function (a) { a.data.dataValue.filterChildren(m.dataFilter, !0) }, null, null, 10); b.on("toHtml", function (a) {
                a = a.data; var b = a.dataValue,
                    c = new CKEDITOR.htmlParser.basicWriter; b.writeChildrenHtml(c); b = c.getHtml(!0); a.dataValue = w(b)
            }, null, null, 15); b.on("toDataFormat", function (a) { var c = a.data.dataValue; a.data.enterMode != CKEDITOR.ENTER_BR && (c = c.replace(/^<br *\/?>/i, "")); a.data.dataValue = CKEDITOR.htmlParser.fragment.fromHtml(c, a.data.context, d(a.data.enterMode, b.config.autoParagraph)) }, null, null, 5); b.on("toDataFormat", function (a) { a.data.dataValue.filterChildren(m.htmlFilter, !0) }, null, null, 10); b.on("toDataFormat", function (a) {
                a.data.filter.applyTo(a.data.dataValue,
                    !1, !0)
            }, null, null, 11); b.on("toDataFormat", function (a) { var c = a.data.dataValue, d = m.writer; d.reset(); c.writeChildrenHtml(d); c = d.getHtml(!0); c = z(c); c = H(c, b); a.data.dataValue = c }, null, null, 15)
        }; CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                var e = this.editor, f, p, m, h; b && "object" == typeof b ? (f = b.context, c = b.fixForBody, d = b.dontFilter, p = b.filter, m = b.enterMode, h = b.protectedWhitespaces) : f = b; f || null === f || (f = e.editable().getName()); return e.fire("toHtml", {
        ...
        }; var L = /(?:&nbsp;|\xa0)$/, y = "{cke_protected}", F = CKEDITOR.dtd, I = "caption colgroup col thead tfoot tbody".split(" "), m = CKEDITOR.tools.extend({}, F.$blockLimit,
            F.$block), C = { elements: { input: g, textarea: g } }, K = { attributeNames: [[/^on/, "data-cke-pa-on"], [/^srcdoc/, "data-cke-pa-srcdoc"], [/^data-cke-expando$/, ""]], elements: { iframe: function (a) { if (a.attributes && a.attributes.src) { var b = a.attributes.src.toLowerCase().replace(/[^a-z]/gi, ""); if (0 === b.indexOf("javascript") || 0 === b.indexOf("data")) a.attributes["data-cke-pa-src"] = a.attributes.src, delete a.attributes.src } } } }, A = {
                elements: {
                    embed: function (a) {
            ...
            }); var r = /<(a|area|img|input|source)\b([^>]*)>/gi, D = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, B = /^(href|src|name)$/i, v = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, S = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, R = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, p = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi, N = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, O = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi;
        n = function () {
    ...
    (function () {
        CKEDITOR.inline = function (a, d) {
            ...
            var a,
            d, b; for (b in CKEDITOR.dtd.$editable) for (var c = CKEDITOR.document.getElementsByTag(b), f = 0, h = c.count(); f < h; f++)a = c.getItem(f), "true" == a.getAttribute("contenteditable") && (d = { element: a, config: {} }, !1 !== CKEDITOR.fire("inline", d) && CKEDITOR.inline(a, d.config))
    ...
    (function () {
        ...
        CKEDITOR.appendTo = function (b, d, h) { return a(b, d, h, CKEDITOR.ELEMENT_MODE_APPENDTO) }; CKEDITOR.replaceAll = function () { for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) { var d = null, k = a[b]; if (k.name || k.id) { if ("string" == typeof arguments[0]) { if (!(new RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)")).test(k.className)) continue } else if ("function" == typeof arguments[0] && (d = {}, !1 === arguments[0](k, d))) continue; this.replace(k, d) } } }; CKEDITOR.editor.prototype.addMode = function (a, b) {
            ...
            var g = this.container, l = this.ui.space("contents"), u = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement; k = k ? this.container.getFirst(function (a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner") }) : g; a = CKEDITOR.tools.convertToPx(CKEDITOR.tools.cssLength(a));
            k.setSize("width", a, !0); u && (u.style.width = "1%"); b = CKEDITOR.tools.convertToPx(CKEDITOR.tools.cssLength(b)); var e = (k.$.offsetHeight || 0) - (l.$.clientHeight || 0), g = Math.max(b - (d ? 0 : e), 0); b = d ? b + e : b; l.setStyle("height", CKEDITOR.tools.cssLength(g)); u && (u.style.width = "100%"); this.fire("resize", { outerHeight: b, contentsHeight: g, outerWidth: a || k.getSize("width") })
    ...
    (function () {
        ...
        function b(a) { var b = a.data.getTarget(); b.is("input") && (b = b.getAttribute("type"), "submit" != b && "reset" != b || a.data.preventDefault()) } function c(a) { return x(a) && w(a) } function f(a, b) { return function (c) { var d = c.data.$.toElement || c.data.$.fromElement || c.data.$.relatedTarget; (d = d && d.nodeType == CKEDITOR.NODE_ELEMENT ? new CKEDITOR.dom.element(d) : null) && (b.equals(d) || b.contains(d)) || a.call(this, c) } } function h(a) {
            ...
            } var d, e = a.getRanges()[0]; a = a.root; var f = { table: 1, ul: 1, ol: 1, dl: 1 }; if (e.startPath().contains(f)) { var r = e.clone(); r.collapse(1); r.setStartAt(a, CKEDITOR.POSITION_AFTER_START); a = new CKEDITOR.dom.walker(r); a.guard = b(); a.checkBackward(); if (d) return r = e.clone(), r.collapse(), r.setEndAt(d, CKEDITOR.POSITION_AFTER_END), a = new CKEDITOR.dom.walker(r), a.guard = b(!0), d = !1, a.checkForward(), d } return null
        } function k(a, b, c) {
            ...
            n, L, y, F, I; CKEDITOR.editable = CKEDITOR.tools.createClass({
                base: CKEDITOR.dom.element, $: function (a, b) { this.base(b.$ || b); this.editor = a; this.status = "unloaded"; this.hasFocus = !1; this.setup() }, proto: {
                    ...
                    }, insertHtml: function (a, b, c) { var d = this.editor; d.focus(); d.fire("saveSnapshot"); c || (c = d.getSelection().getRanges()[0]); n(this, b || "html", a, c); c.select(); u(this); this.editor.fire("afterInsertHtml", {}) }, insertHtmlIntoRange: function (a, b, c) { n(this, c || "html", a, b); this.editor.fire("afterInsertHtml", { intoRange: b }) }, insertElement: function (a, b) {
                        var d =
                    ...
                    fixInitialSelection: function () {
                        ...
                        a = { doc: this.getDocument(), range: a.clone() }; F.eol.detect(a, this); F.bogus.exclude(a); F.cell.shrink(a); a.fragment = a.range.cloneContents(); F.tree.rebuild(a, this); F.eol.fix(a, this); return new CKEDITOR.dom.documentFragment(a.fragment.$)
                    }, extractHtmlFromRange: function (a, b) {
                        var c = I, d = { range: a, doc: a.document }, e = this.getHtmlFromRange(a); if (a.collapsed) return a.optimize(), e; a.enlarge(CKEDITOR.ENLARGE_INLINE, 1); c.table.detectPurge(d); d.bookmark = a.createBookmark(); delete d.range; var f = this.editor.createRange();
                        ...
                        if (b) { c = a.startPath(); if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) { a: { var d = c.block.getElementsByTag("span"), f = 0, g; if (d) for (; g = d.getItem(f++);)if (!w(g)) { d = !0; break a } d = !1 } d = !d } d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START), c.block.remove()) } else c.autoParagraph(this.editor, a), z(a.startContainer) && a.startContainer.appendBogus(); a.startContainer.mergeSiblings(); return e
                    }, setup: function () {
                        var a = this.editor; this.attachListener(a, "beforeGetData", function () {
                            var b =
                                this.getData(); this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(t, function (a, b) { return b })); a.setData(b, null, 1)
                                        ...
                                        !a.config.disableNativeSpellChecker); var g = a.config.contentsLangDirection; this.getDirection(1) != g && this.changeAttr("dir", g); var k = CKEDITOR.getCss(); if (k) { var g = f.getHead(), r = g.getCustomData("stylesheet"); r ? k != r.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? r.$.styleSheet.cssText = k : r.setText(k)) : (k = f.appendStyleText(k), k = new CKEDITOR.dom.element(k.ownerNode || k.owningElement), g.setCustomData("stylesheet", k), k.data("cke-temp", 1)) } g = f.getCustomData("stylesheet_ref") || 0; f.setCustomData("stylesheet_ref",
                                            g + 1); this.setCustomData("cke_includeReadonly", !a.config.disableReadonlyStyling); this.attachListener(this, "click", function (a) { a = a.data; var b = (new CKEDITOR.dom.elementPath(a.getTarget(), this)).contains("a"); b && 2 != a.$.button && b.isReadOnly() && a.preventDefault() }); var D = { 8: 1, 46: 1 }; this.attachListener(a, "key", function (b) {
                                                if (a.readOnly) return !0; var c = b.data.domEvent.getKey(), d; b = a.getSelection(); if (0 !== b.getRanges().length) {
                                                    if (c in D) {
                                                        var e, f = b.getRanges()[0], r = f.startPath(), g, q, k, c = 8 == c; CKEDITOR.env.ie &&
                                                ...
                                                this.attachListener(this, "keyup", function (b) { b.data.getKeystroke() in D && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select()) }); this.attachListener(this, "dblclick", function (b) { if (a.readOnly) return !1; b = { element: b.data.getTarget() }; a.fire("doubleclick", b) }); CKEDITOR.env.ie && this.attachListener(this, "click", b); CKEDITOR.env.ie && !CKEDITOR.env.edge || this.attachListener(this, "mousedown", function (b) {
                                                    ...
                                                    if (2 == b.data.$.button && (b = b.data.getTarget(), !b.getAscendant("table") && !b.getOuterHtml().replace(t, ""))) {
                                                        ...
                                                        var c = 8 == c, d = b.getRanges()[0]; b = d.startPath(); if (d.collapsed) a: {
                                                            var f =
                                                                b.block; if (f && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(f, !c) && d.collapsed) {
                                                                    if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) { var p = d.startContainer.getChild(d.startOffset - (c ? 1 : 0)); if (p && p.type == CKEDITOR.NODE_ELEMENT && p.is("hr")) { a.fire("saveSnapshot"); p.remove(); b = !0; break a } } d = d.startPath().block; if (!d || d && d.contains(f)) b = void 0; else {
                                                                        a.fire("saveSnapshot"); var r; (r = (c ? d : f).getBogus()) && r.remove(); r = a.getSelection(); p = r.createBookmarks(); (c ? f : d).moveChildren(c ?
                                                                            d : f, !1); b.lastElement.mergeSiblings(); e(f, d, !c); r.selectBookmarks(p); b = !0
                                                                    }
                                                                } else b = !1
        ...
        x = CKEDITOR.dom.walker.whitespaces(!0); w = CKEDITOR.dom.walker.bookmark(!1, !0); z = CKEDITOR.dom.walker.empty(); H = CKEDITOR.dom.walker.bogus(); t = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi; n = function () {
            function a(b) { return b.type == CKEDITOR.NODE_ELEMENT } function b(c, d) {
                var e, f, r, g, h = [], k = d.range.startContainer; e = d.range.startPath(); for (var k = B[k.getName()], D = 0, v = c.getChildren(), l = v.count(), n = -1, A = -1, u = 0, S = e.contains(B.$list); D <
                ...
                var e = [],
                f = b.getChildren(), r = f.count(), g, h = 0, k = B[c], D = !b.is(B.$inline) || b.is("br"); for (D && e.push(" "); h < r; h++)g = f.getItem(h), a(g) && !g.is(k) ? e = e.concat(d(g, c)) : e.push(g); D && e.push(" "); return e
            } function e(b) { return a(b.startContainer) && b.startContainer.getChild(b.startOffset - 1) } function f(b) { return b && a(b) && (b.is(B.$removeEmpty) || b.is("a") && !b.isBlockBoundary()) } function r(b, c, d, e) {
            ...
            } function h(b, c) { function d(b, c) { if (c.isBlock && c.isElement && !c.node.is("br") && a(b) && b.is("br")) return b.remove(), 1 } var e = c.endContainer.getChild(c.endOffset), f = c.endContainer.getChild(c.endOffset - 1); e && d(e, b[b.length - 1]); f && d(f, b[0]) && (c.setEnd(c.endContainer, c.endOffset - 1), c.collapse()) } var B = CKEDITOR.dtd, v = {
                p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1,
                h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1
            }, n = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 }, u = CKEDITOR.tools.extend({}, B.$inline); delete u.br; return function (p, v, O, q) {
                var G = p.editor, E = !1; "unfiltered_html" == v && (v = "html", E = !0); if (!q.checkReadOnly()) {
                    var w = (new CKEDITOR.dom.elementPath(q.startContainer, q.root)).blockLimit || q.root; v = { type: v, dontFilter: E, editable: p, editor: G, range: q, blockLimit: w, mergeCandidates: [], zombies: [] }; var E = v.range, w = v.mergeCandidates, J = "html" === v.type, x, t, z, y, H, U; "text" == v.type &&
                        E.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (t = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", E.document), E.insertNode(t), E.setStartAfter(t)); z = new CKEDITOR.dom.elementPath(E.startContainer); v.endPath = y = new CKEDITOR.dom.elementPath(E.endContainer); if (!E.collapsed) { x = y.block || y.blockLimit; var aa = E.getCommonAncestor(); x && !x.equals(aa) && !x.contains(aa) && E.checkEndOfBlock() && v.zombies.push(x); E.deleteContents() } for (; (H = e(E)) && a(H) && H.isBlockBoundary() && z.contains(H);)E.moveToPosition(H,
                            CKEDITOR.POSITION_BEFORE_END); r(E, v.blockLimit, z, y); t && (E.setEndBefore(t), E.collapse(), t.remove()); t = E.startPath(); if (x = t.contains(f, !1, 1)) U = E.splitElement(x), v.inlineStylesRoot = x, v.inlineStylesPeak = t.lastElement; t = E.createBookmark(); J && (l(x), l(U)); (x = t.startNode.getPrevious(c)) && a(x) && f(x) && w.push(x); (x = t.startNode.getNext(c)) && a(x) && f(x) && w.push(x); for (x = t.startNode; (x = x.getParent()) && f(x);)w.push(x); E.moveToBookmark(t); G.enterMode === CKEDITOR.ENTER_DIV && "" === G.getData(!0) && ((G = p.getFirst()) && G.remove(),
                                q.setStartAt(p, CKEDITOR.POSITION_AFTER_START), q.collapse(!0)); if (p = O) {
                                    p = v.range; if ("text" == v.type && v.inlineStylesRoot) { q = v.inlineStylesPeak; G = q.getDocument().createText("{cke-peak}"); for (U = v.inlineStylesRoot.getParent(); !q.equals(U);)G = G.appendTo(q.clone()), q = q.getParent(); O = G.getOuterHtml().split("{cke-peak}").join(O) } q = v.blockLimit.getName(); if (/^\s+|\s+$/.test(O) && "span" in CKEDITOR.dtd[q]) { var V = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e'; O = V + O + V } O = v.editor.dataProcessor.toHtml(O,
                                        { context: null, fixForBody: !1, protectedWhitespaces: !!V, dontFilter: v.dontFilter, filter: v.editor.activeFilter, enterMode: v.editor.activeEnterMode }); q = p.document.createElement("body"); q.setHtml(O); V && (q.getFirst().remove(), q.getLast().remove()); if ((V = p.startPath().block) && (1 != V.getChildCount() || !V.getBogus())) a: {
                                            var P; if (1 == q.getChildCount() && a(P = q.getFirst()) && P.is(n) && !P.hasAttribute("contenteditable")) {
                                                V = P.getElementsByTag("*"); p = 0; for (U = V.count(); p < U; p++)if (G = V.getItem(p), !G.is(u)) break a; P.moveChildren(P.getParent(1));
                                                P.remove()
                                            }
                                        } v.dataWrapper = q; p = O
                                } if (p) {
                                    P = v.range; p = P.document; q = v.blockLimit; U = 0; var Q, V = [], F, I; O = t = 0; var L, G = P.startContainer; H = v.endPath.elements[0]; var Z, E = H.getPosition(G), w = !!H.getCommonAncestor(G) && E != CKEDITOR.POSITION_IDENTICAL && !(E & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED), G = b(v.dataWrapper, v); for (h(G, P); U < G.length; U++) {
                                        E = G[U]; if (J = E.isLineBreak) J = P, x = q, y = z = void 0, E.hasBlockSibling ? J = 1 : (z = J.startContainer.getAscendant(B.$block, 1)) && z.is({ div: 1, p: 1 }) ? (y = z.getPosition(x), y ==
                                            CKEDITOR.POSITION_IDENTICAL || y == CKEDITOR.POSITION_CONTAINS ? J = 0 : (x = J.splitElement(z), J.moveToPosition(x, CKEDITOR.POSITION_AFTER_START), J = 1)) : J = 0; if (J) O = 0 < U; else {
                                                J = P.startPath(); !E.isBlock && k(v.editor, J.block, J.blockLimit) && (I = g(v.editor)) && (I = p.createElement(I), I.appendBogus(), P.insertNode(I), CKEDITOR.env.needsBrFiller && (Q = I.getBogus()) && Q.remove(), P.moveToPosition(I, CKEDITOR.POSITION_BEFORE_END)); if ((J = P.startPath().block) && !J.equals(F)) { if (Q = J.getBogus()) Q.remove(), V.push(J); F = J } E.firstNotAllowed &&
                                                ...
                                                E.lastNotAllowed && U < G.length - 1 && ((L = w ? H : L) && P.setEndAt(L, CKEDITOR.POSITION_AFTER_START), t = 0); P.collapse()
                                            }
                                    } 1 != G.length ? Q = !1 : (Q = G[0], Q = Q.isElement && "false" == Q.node.getAttribute("contenteditable")); Q && (O = !0, J = G[0].node, P.setStartAt(J, CKEDITOR.POSITION_BEFORE_START), P.setEndAt(J, CKEDITOR.POSITION_AFTER_END)); v.dontMoveCaret = O; v.bogusNeededBlocks = V
                                } Q = v.range; var Y; L = v.bogusNeededBlocks; for (Z = Q.createBookmark(); F = v.zombies.pop();)F.getParent() && (I = Q.clone(), I.moveToElementEditStart(F), I.removeEmptyBlocksAtEnd());
                    if (L) for (; F = L.pop();)CKEDITOR.env.needsBrFiller ? F.appendBogus() : F.append(Q.document.createText(" ")); for (; F = v.mergeCandidates.pop();)F.mergeSiblings(); Q.moveToBookmark(Z); if (!v.dontMoveCaret) { for (F = e(Q); F && a(F) && !F.is(B.$empty);) { if (F.isBlockBoundary()) Q.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END); else { if (f(F) && F.getHtml().match(/(\s|&nbsp;)$/g)) { Y = null; break } Y = Q.clone(); Y.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END) } F = F.getLast(c) } Y && Q.moveToRange(Y) }
                }
            }
        }(); L = function () {
            function a(b) {
        ...
        y = function () {
            ...
            }, bogus: { exclude: function (a) { var b = a.range.getBoundaryNodes(), c = b.startNode, b = b.endNode; !b || !H(b) || c && c.equals(b) || a.range.setEndBefore(b) } },
            tree: {
            ...
            function a(b, c) {
                ...
                list: {
                    ...
                    function a(c) {
                        var e = [], f, g = new CKEDITOR.dom.walker(c), h = c.startPath().contains(d), p = c.endPath().contains(d), k = {}; g.guard = function (a, g) {
                        ...
                        detectPurge: function (a) {
                            ...
                            var g = c(f, e.bookmark), h = g.clone(), k, p, l = g.getCommonAncestor(); l.is(CKEDITOR.dtd.$tableContent) && !l.is(d) && (l = l.getAscendant("table", !0)); p = l; l = new CKEDITOR.dom.elementPath(g.startContainer, p); p = new CKEDITOR.dom.elementPath(g.endContainer, p); l = l.contains("table"); p = p.contains("table"); if (l || p) l && p && b(l, p) ? (e.tableSurroundingRange =
    ...
    (function () {
        function a(a) { return CKEDITOR.plugins.widget && CKEDITOR.plugins.widget.isDomWidget(a) } function d(b, c) {
            ...
            return c += d.join("\t")
        } function f(a) { var b = this.root.editor, d = b.getSelection(1); this.reset(); I = !0; d.root.once("selectionchange", function (a) { a.cancel() }, null, null, 0); d.selectRanges([a[0]]); d = this._.cache; d.ranges = new CKEDITOR.dom.rangeList(a); d.type = CKEDITOR.SELECTION_TEXT; d.selectedElement = a[0]._getTableElement(); d.selectedText = c(a); d.nativeSel = null; this.isFake = 1; this.rev = L++; b._.fakeSelection = this; I = !1; this.root.fire("selectionchange") } function h() {
                ...
                var e; if (!(e = !c) && (e = !c.isHidden())) {
                    e = b; var f = c.getRanges(), g = e.getRanges(), h = f.length && f[0]._getTableElement() && f[0]._getTableElement().getAscendant("table", !0), p = g.length && g[0]._getTableElement() && g[0]._getTableElement().getAscendant("table", !0), k = 1 === f.length && f[0]._getTableElement() && f[0]._getTableElement().is("table"), l = 1 === g.length && g[0]._getTableElement() && g[0]._getTableElement().is("table"); if (a(e.getSelectedElement())) e = !1; else {
                        var q = 1 === f.length && f[0].collapsed, g = d(f, !!CKEDITOR.env.webkit) &&
                            d(g); h = h && p ? h.equals(p) || p.contains(h) : !1; h && (q || g) ? (k && !l && e.selectRanges(f), e = !0) : e = !1
                    } e = !e
                } e && (b.reset(), b = 0)
        ...
        } function k() { C = !0; m || (g.call(this), m = CKEDITOR.tools.setTimeout(g, 200, this)) } function g() { m = null; C && (CKEDITOR.tools.setTimeout(h, 0, this), C = !1) } function l(a) { return K(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 } function u(a) {
        ...
        } function w(a, b) { return b ? a.replace(F, function (a, b) { return b ? " " : "" }) : a.replace(y, "") } function z(a, b) {
        ...
        } function H(a) { var b = { 37: 1, 39: 1, 8: 1, 46: 1 }; return function (c) { var d = c.data.getKeystroke(); if (b[d]) { var e = a.getSelection().getRanges(), f = e[0]; 1 == e.length && f.collapsed && (d = f[38 > d ? "getPreviousEditableNode" : "getNextEditableNode"]()) && d.type == CKEDITOR.NODE_ELEMENT && "false" == d.getAttribute("contenteditable") && (a.getSelection().fake(d), c.data.preventDefault(), c.cancel()) } } } function t(a) {
        ...
        } var n = "function" != typeof window.getSelection, L = 1, y = CKEDITOR.tools.repeat("​", 7), F = new RegExp(y + "( )?", "g"), I, m, C, K = CKEDITOR.dom.walker.invisible(1), A = function () {
            function a(b) {
                return function (a) {
                    var c =
            ...
            function b() { var a = c.getSelection(); a && a.removeAllRanges() } var c = a.editor; c.on("contentDom", function () {
                function a() { u = new CKEDITOR.dom.selection(c.getSelection()); u.lock() } function b() { g.removeListener("mouseup", b); r.removeListener("mouseup", b); var a = CKEDITOR.document.$.selection, c = a.createRange(); "None" != a.type && c.parentElement() && c.parentElement().ownerDocument == f.$ && c.select() } function d(a) {
                    var b,
                    c; b = (b = this.document.getActive()) ? "input" === b.getName() || "textarea" === b.getName() : !1; b || (b = this.getSelection(1), (c = e(b)) && !c.equals(q) && (b.selectElement(c), a.data.preventDefault()))
                } function e(a) { a = a.getRanges()[0]; return a ? (a = a.startContainer.getAscendant(function (a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") }, !0)) && "false" === a.getAttribute("contenteditable") ? a : null : null } var f = c.document, g = CKEDITOR.document, q = c.editable(), l = f.getBody(), r = f.getDocumentElement(), D = q.isInline(),
                    m, u; CKEDITOR.env.gecko && q.attachListener(q, "focus", function (a) { a.removeListener(); 0 !== m && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == q.$ && (a = c.createRange(), a.moveToElementEditStart(q), a.select()) }, null, null, -2); q.attachListener(q, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function () {
                        if (m && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                            m = c._.previousActive && c._.previousActive.equals(f.getActive()); var a = null != c._.previousScrollTop && c._.previousScrollTop != q.$.scrollTop;
                            CKEDITOR.env.webkit && m && a && (q.$.scrollTop = c._.previousScrollTop)
                        } c.unlockSelection(m); m = 0
                    }, null, null, -1); q.attachListener(q, "mousedown", function () { m = 0 }); if (CKEDITOR.env.ie || CKEDITOR.env.gecko || D) n ? q.attachListener(q, "beforedeactivate", a, null, null, -1) : q.attachListener(c, "selectionCheck", a, null, null, -1), q.attachListener(q, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusout" : "blur", function () { var a = u && (u.isFake || 2 > u.getRanges().length); CKEDITOR.env.gecko && !D && a || (c.lockSelection(u), m = 1) }, null, null, -1),
                        q.attachListener(q, "mousedown", function () { m = 0 }); if (CKEDITOR.env.ie && !D) {
                            var w; q.attachListener(q, "mousedown", function (a) { 2 == a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (w = c.window.getScrollPosition())) }); q.attachListener(q, "mouseup", function (a) { 2 == a.data.$.button && w && (c.document.$.documentElement.scrollLeft = w.x, c.document.$.documentElement.scrollTop = w.y); w = null }); if ("BackCompat" != f.$.compatMode) {
                                if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                                    var t, z;
                                    r.on("mousedown", function (a) {
                                        function b(a) { a = a.data.$; if (t) { var c = l.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) { } t.setEndPoint(0 > z.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c); t.select() } } function c() { r.removeListener("mousemove", b); g.removeListener("mouseup", c); r.removeListener("mouseup", c); t.select() } a = a.data; if (a.getTarget().is("html") && a.$.y < r.$.clientHeight && a.$.x < r.$.clientWidth) {
                                            t = l.$.createTextRange(); try { t.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) { } z =
                                                t.duplicate(); r.on("mousemove", b); g.on("mouseup", c); r.on("mouseup", c)
                                        }
                                    })
                                } if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version) r.on("mousedown", function (a) { a.data.getTarget().is("html") && (g.on("mouseup", b), r.on("mouseup", b)) })
                            }
                        } q.attachListener(q, "selectionchange", h, c); q.attachListener(q, "keyup", k, c); q.attachListener(q, "touchstart", k, c); q.attachListener(q, "touchend", k, c); CKEDITOR.env.ie && q.attachListener(q, "keydown", d, c); q.attachListener(q, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function () {
                            c.forceNextSelectionCheck();
                            c.selectionChange(1)
                        }); if (D && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) { var y; q.attachListener(q, "mousedown", function () { y = 1 }); q.attachListener(f.getDocumentElement(), "mouseup", function () { y && k.call(c); y = 0 }) } else q.attachListener(CKEDITOR.env.ie ? q : f.getDocumentElement(), "mouseup", k, c); CKEDITOR.env.webkit && q.attachListener(f, "keydown", function (a) { switch (a.data.getKey()) { case 13: case 33: case 34: case 35: case 36: case 37: case 39: case 8: case 45: case 46: q.hasFocus && x(q) } }, null, null, -1); q.attachListener(q,
                            "keydown", H(c), null, null, -1)
            ...
            }, null, null, -1); b.on("beforeSetMode", function () { x(b.editable()) }, null, null, -1); b.on("getSnapshot", function (a) { a.data && (a.data = w(a.data)) }, b, null, 20); b.on("toDataFormat", function (a) { a.data.dataValue = w(a.data.dataValue) }, null, null, 0)
                ...
                getNative: function () { return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = n ? this.document.$.selection : this.document.getWindow().$.getSelection() }, getType: n ? function () {
                    ...
                    var a = n ? function () {
                        function a(b) { return (new CKEDITOR.dom.node(b)).getIndex() } var b = function (b, c) {
                            b = b.duplicate(); b.collapse(c); var d = b.parentElement(); if (!d.hasChildNodes()) return { container: d, offset: 0 }; for (var e = d.children, f, g, h = b.duplicate(), k = 0, l = e.length - 1, r = -1, n, m; k <= l;)if (r = Math.floor((k + l) / 2), f = e[r], h.moveToElementText(f), n = h.compareEndPoints("StartToStart", b), 0 < n) l = r - 1; else if (0 > n) k = r + 1; else return { container: d, offset: a(f) };
                            ...
                            if (!h) return { container: d, offset: a(f) + (0 < n ? 0 : 1) }; for (; 0 < h;)try { g = f[0 < n ? "previousSibling" : "nextSibling"], g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, m = g), f = g } catch (u) { return { container: d, offset: a(f) } } return { container: m, offset: 0 < n ? -h : m.nodeValue.length + h }
                        }; return function () {
                    ...
                    }; return function (b) { var c = this._.cache, d = c.ranges; d || (c.ranges = d = new CKEDITOR.dom.rangeList(a.call(this))); return b ? t(new CKEDITOR.dom.rangeList(d.slice())) : d }
                    ...
                    } else CKEDITOR.warn("selection-fake-reset"); this.rev = L++
                    ...
                    var b = this.root.editor, c = b && b._.hiddenSelectionContainer; this.reset(); if (c) for (var c = this.root, g, h = 0; h < a.length; ++h)g =
                        a[h], g.endContainer.equals(c) && (g.endOffset = Math.min(g.endOffset, c.getChildCount())); if (a.length) if (this.isLocked) { var k = CKEDITOR.document.getActive(); this.unlock(); this.selectRanges(a); this.lock(); k && !k.equals(this.root) && k.focus() } else {
                            var p; a: {
                                var l, m; if (1 == a.length && !(m = a[0]).collapsed && (p = m.getEnclosedNode()) && p.type == CKEDITOR.NODE_ELEMENT && (m = m.clone(), m.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (l = m.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (p = l), "false" == p.getAttribute("contenteditable"))) break a;
                                p = void 0
                            } if (p) this.fake(p); else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment(b) && d(a) && !I && !a[0]._getTableElement({ table: 1 }).hasAttribute("data-cke-tableselection-ignored")) f.call(this, a); else {
                                if (n) {
                                    l = CKEDITOR.dom.walker.whitespaces(!0); p = /\ufeff|\u00a0/; m = { table: 1, tbody: 1, tr: 1 }; 1 < a.length && (b = a[a.length - 1], a[0].setEnd(b.endContainer, b.endOffset)); b = a[0]; a = b.collapsed; var q, G, E; if ((c = b.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in M && (!c.is("a") ||
                                    ...
                                    k = this.getNative(); if (!k) return; this.removeAllRanges(); for (E = 0; E < a.length; E++) {
                                        if (E < a.length - 1 && (q = a[E], G = a[E + 1], p = q.clone(), p.setStart(q.endContainer, q.endOffset), p.setEnd(G.startContainer, G.startOffset), !p.collapsed && (p.shrink(CKEDITOR.NODE_ELEMENT, !0), b = p.getCommonAncestor(), p = p.getEnclosedNode(), b.isReadOnly() || p && p.isReadOnly()))) { G.setStart(q.startContainer, q.startOffset); a.splice(E--, 1); continue } b = a[E]; G = this.document.$.createRange(); b.collapsed &&
                                            CKEDITOR.env.webkit && u(b) && (p = e(this.root), b.insertNode(p), (q = p.getNext()) && !p.getPrevious() && q.type == CKEDITOR.NODE_ELEMENT && "br" == q.getName() ? (x(this.root), b.moveToPosition(q, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(p, CKEDITOR.POSITION_AFTER_END)); G.setStart(b.startContainer.$, b.startOffset); try { G.setEnd(b.endContainer.$, b.endOffset) } catch (t) { if (0 <= t.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), G.setEnd(b.endContainer.$, b.endOffset); else throw t; } k.addRange(G)
                                    }
                                } this.reset();
                                this.root.fire("selectionchange")
                            }
                        }
                }, fake: function (a, b) { var c = this.root.editor; void 0 === b && a.hasAttribute("aria-label") && (b = a.getAttribute("aria-label")); this.reset(); z(c, b); var d = this._.cache, e = new CKEDITOR.dom.range(this.root); e.setStartBefore(a); e.setEndAfter(a); d.ranges = new CKEDITOR.dom.rangeList(e); d.selectedElement = d.startElement = a; d.type = CKEDITOR.SELECTION_ELEMENT; d.selectedText = d.nativeSel = null; this.isFake = 1; this.rev = L++; c._.fakeSelection = this; this.root.fire("selectionchange") }, isHidden: function () {
                    var a =
    ...
    (function () {
        function a(a, b) { for (var c, d; (a = a.getParent()) && !a.equals(b);)if (a.getAttribute("data-nostyle")) c = a; else if (!d) { var e = a.getAttribute("contentEditable"); "false" == e ? c = a : "true" == e && (d = 1) } return c } function d(a, b, c, d) { return (a.getPosition(b) | d) == d && (!c.childRule || c.childRule(a)) } function b(c) {
            var e = c.document; if (c.collapsed) e = L(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                var g = this.element, h = this._.definition, k, l = h.ignoreReadonly, m = l || h.includeReadonly; null ==
                    m && (m = c.root.getCustomData("cke_includeReadonly")); var n = CKEDITOR.dtd[g]; n || (k = !0, n = CKEDITOR.dtd.span); c.enlarge(CKEDITOR.ENLARGE_INLINE, 1); c.trim(); var u = c.createBookmark(), x = u.startNode, w = u.endNode, r = x, t; if (!l) { var v = c.getCommonAncestor(), l = a(x, v), v = a(w, v); l && (r = l.getNextSourceNode(!0)); v && (w = v) } for (r.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                        l = !1; if (r.equals(w)) r = null, l = !0; else {
                            var z = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null, v = z && "false" == r.getAttribute("contentEditable"), y = z &&
                            ...
                            for (var l = L(this, e), v = l.hasAttributes(), y = t.getCommonAncestor(),
                                z = {}, C = {}, D = {}, F = {}, X, W, Y; l && y;) { if (y.getName() == g) { for (X in h.attributes) !F[X] && (Y = y.getAttribute(W)) && (l.getAttribute(X) == Y ? C[X] = 1 : F[X] = 1); for (W in h.styles) !D[W] && (Y = y.getStyle(W)) && (l.getStyle(W) == Y ? z[W] = 1 : D[W] = 1) } y = y.getParent() } for (X in C) l.removeAttribute(X); for (W in z) l.removeStyle(W); v && !l.hasAttributes() && (l = null); l ? (t.extractContents().appendTo(l), t.insertNode(l), H.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), t.extractContents().appendTo(l),
                                    t.insertNode(l), H.call(this, l), l.remove(!0)); t = null
                        }
                    } c.moveToBookmark(u); c.shrink(CKEDITOR.SHRINK_TEXT); c.shrink(CKEDITOR.NODE_ELEMENT, !0)
            }
        } function c(a) {
            function b() {
                ...
                for (var f = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, h = 0, k; h < f.elements.length && (k = f.elements[h]) && k != f.block && k != f.blockLimit; h++)if (this.checkElementRemovable(k)) {
                    var l; !e && a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (l = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (g = k, g.match = l ? "start" : "end") :
                        (k.mergeSiblings(), k.is(this.element) ? z.call(this, k) : t(k, I(this)[k.getName()]))
                ...
                var m = c.endNode, n = this; b(); for (f = d; !f.equals(m);)g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? z.call(this, f) : t(f, I(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) &&
                    (b(), g = d.getNext())), f = g
        ...
        } function g(a) { var b = a.createBookmark(!0), c = a.createIterator(); c.enforceRealBlocks = !0; this._.enterMode && (c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR); for (var d, e = a.document, f; d = c.getNextParagraph();)!d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = L(this, e, d), u(d, f)); a.moveToBookmark(b) } function l(a) {
            var b = a.createBookmark(1),
            c = a.createIterator(); c.enforceRealBlocks = !0; c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR; for (var d, e; d = c.getNextParagraph();)this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), u(d, e)) : z.call(this, d)); a.moveToBookmark(b)
        } function u(a, b) {
            ...
            var c = this._.definition, d = c.attributes, c = c.styles, e = I(this)[a.getName()], f = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), g; for (g in d) if ("class" != g && !this._.definition.fullMatch || a.getAttribute(g) == m(g, d[g])) b && "data-" == g.slice(0, 5) || (f = a.hasAttribute(g), a.removeAttribute(g)); for (var h in c) this._.definition.fullMatch && a.getStyle(h) != m(h, c[h], !0) || (f = f || !!a.getStyle(h), a.removeStyle(h));
            t(a, e, A[a.getName()]); f && (this._.definition.alwaysRemoveElement ? n(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? n(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div"))
        } function H(a) { for (var b = I(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;)d = c.getItem(e), d.isReadOnly() || z.call(this, d, !0); for (var f in b) if (f != this.element) for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--)d = c.getItem(e), d.isReadOnly() || t(d, b[f]) } function t(a,
            b, c) { if (b = b && b.attributes) for (var d = 0; d < b.length; d++) { var e = b[d][0], f; if (f = a.getAttribute(e)) { var g = b[d][1]; (null === g || g.test && g.test(f) || "string" == typeof g && f == g) && a.removeAttribute(e) } } c || n(a) } function n(a, b) {
                if (!a.hasAttributes() || b) if (CKEDITOR.dtd.$block[a.getName()]) { var c = a.getPrevious(v), d = a.getNext(v); !c || c.type != CKEDITOR.NODE_TEXT && c.isBlockBoundary({ br: 1 }) || a.append("br", 1); !d || d.type != CKEDITOR.NODE_TEXT && d.isBlockBoundary({ br: 1 }) || a.append("br"); a.remove(!0) } else c = a.getFirst(), d = a.getLast(),
                    a.remove(!0), c && (c.type == CKEDITOR.NODE_ELEMENT && c.mergeSiblings(), d && !c.equals(d) && d.type == CKEDITOR.NODE_ELEMENT && d.mergeSiblings())
            } function L(a, b, c) { var d; d = a.element; "*" == d && (d = "span"); d = new CKEDITOR.dom.element(d, b); c && c.copyAttributes(d); d = y(d, a); b.getCustomData("doc_processing_style") && d.hasAttribute("id") ? d.removeAttribute("id") : b.setCustomData("doc_processing_style", 1); return d } function y(a, b) {
            ...
            } function F(a, b) { for (var c in a) a[c] = a[c].replace(D, function (a, c) { return b[c] }) } function I(a) {
            ...
            }, r = /\s*(?:;\s*|$)/, D = /#\((.+?)\)/g, B = CKEDITOR.dom.walker.bookmark(0, 1), v = CKEDITOR.dom.walker.whitespaces(1); CKEDITOR.style = function (a, b) {
                ...
                apply: function (a) { if (a instanceof CKEDITOR.dom.document) return K.call(this, a.getSelection()); if (this.checkApplicable(a.elementPath(), a)) { var b = this._.enterMode; b || (this._.enterMode = a.activeEnterMode); K.call(this, a.getSelection(), 0, a); this._.enterMode = b } }, remove: function (a) {
                    ...
                    if (this.checkElementMatch(a, b, c)) return !0; if (b = I(this)[a.getName()]) {
                        var d;
        ...
        }; var S = CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED, R = CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED
        ...
        var a = {}, d = {}, b; for (b in CKEDITOR.dtd.$blockLimit) b in CKEDITOR.dtd.$list || (a[b] = 1); for (b in CKEDITOR.dtd.$block) b in CKEDITOR.dtd.$blockLimit || b in CKEDITOR.dtd.$empty || (d[b] = 1); CKEDITOR.dom.elementPath = function (b, f) {
            var h = null, k = null, g = [], l = b, u; f = f || b.getDocument().getBody(); l || (l = f); do if (l.type == CKEDITOR.NODE_ELEMENT) {
                g.push(l); if (!this.lastElement && (this.lastElement = l, l.is(CKEDITOR.dtd.$object) || "false" == l.getAttribute("contenteditable"))) continue; if (l.equals(f)) break; if (!k && (u = l.getName(),
                    "true" == l.getAttribute("contenteditable") ? k = l : !h && d[u] && (h = l), a[u])) { if (u = !h && "div" == u) { a: { u = l.getChildren(); for (var e = 0, x = u.count(); e < x; e++) { var w = u.getItem(e); if (w.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[w.getName()]) { u = !0; break a } } u = !1 } u = !u } u ? h = l : k = l }
...
*/
    ...
    (function () {
        ...
        function aa(a) { function b() { a.layout() } var c = CKEDITOR.document.getWindow(); c.on("resize", b); a.on("hide", function () { c.removeListener("resize", b) }) } function M(a, b) { this.dialog = a; for (var c = b.contents, e = 0, d; d = c[e]; e++)c[e] = d && new N(a, d); CKEDITOR.tools.extend(this, b) } function N(a, b) { this._ = { dialog: a }; CKEDITOR.tools.extend(this, b) } function ba(a) {
            function b(b) {
                var c = a.getSize(), k = a.parts.dialog.getParent().getClientSize(), q = b.data.$.screenX, l = b.data.$.screenY, r = q - e.x, n = l - e.y; e = { x: q, y: l }; d.x += r; d.y += n; q =
                    d.x + h[3] < g ? -h[3] : d.x - h[1] > k.width - c.width - g ? k.width - c.width + ("rtl" == f.lang.dir ? 0 : h[1]) : d.x; c = d.y + h[0] < g ? -h[0] : d.y - h[2] > k.height - c.height - g ? k.height - c.height + h[2] : d.y; q = Math.floor(q); c = Math.floor(c); a.move(q, c, 1); b.data.preventDefault()
            } function c() { CKEDITOR.document.removeListener("mousemove", b); CKEDITOR.document.removeListener("mouseup", c); if (CKEDITOR.env.ie6Compat) { var a = u.getChild(0).getFrameDocument(); a.removeListener("mousemove", b); a.removeListener("mouseup", c) } } var e = null, d = null, f = a.getParentEditor(),
            ...
            function b(b) {
                var c = "rtl" == f.lang.dir, q = k.width, l = k.height, w = q + (b.data.$.screenX - m.x) * (c ? -1 : 1) * (a._.moved ? 1 : 2), C = l + (b.data.$.screenY - m.y) * (a._.moved ? 1 : 2), E = a._.element.getFirst(), E = c && parseInt(E.getComputedStyle("right"), 10), v = a.getPosition(); v.x = v.x || 0; v.y = v.y || 0; v.y + C > p.height && (C = p.height - v.y); (c ? E : v.x) + w > p.width && (w = p.width - (c ? E : v.x)); C = Math.floor(C); w = Math.floor(w); if (d == CKEDITOR.DIALOG_RESIZE_WIDTH || d == CKEDITOR.DIALOG_RESIZE_BOTH) q = Math.max(e.minWidth || 0, w - g); if (d == CKEDITOR.DIALOG_RESIZE_HEIGHT ||
                    d == CKEDITOR.DIALOG_RESIZE_BOTH) l = Math.max(e.minHeight || 0, C - h); a.resize(q, l); a._.moved && O(a, a._.position.x, a._.position.y); a._.moved || a.layout(); b.data.preventDefault()
            } function c() { CKEDITOR.document.removeListener("mouseup", c); CKEDITOR.document.removeListener("mousemove", b); q && (q.remove(), q = null); if (CKEDITOR.env.ie6Compat) { var a = u.getChild(0).getFrameDocument(); a.removeListener("mouseup", c); a.removeListener("mousemove", b) } } var e = a.definition, d = e.resizable; if (d != CKEDITOR.DIALOG_RESIZE_NONE) {
                var f =
                    a.getParentEditor(), g, h, p, m, k, q, l = CKEDITOR.tools.addFunction(function (d) {
                        function e(a) { return a.isVisible() } k = a.getSize(); var f = a.parts.contents, l = f.$.getElementsByTagName("iframe").length, w = !(CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.quirks); l && (q = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_dialog_resize_cover" style\x3d"height: 100%; position: absolute; width: 100%; left:0; top:0;"\x3e\x3c/div\x3e'), f.append(q)); h = k.height - a.parts.contents.getFirst(e).getSize("height", w);
            ...
            var e = a.parts.dialog.getParent().getClientSize(), d = a.getSize(), f = a._.viewportRatio, g = Math.max(e.width - d.width, 0), e = Math.max(e.height - d.height, 0); f.width = g ? b / g : f.width; f.height = e ? c / e : f.height;
            a._.viewportRatio = f
            ...
            var b = a.config, c = CKEDITOR.skinName || a.config.skin, e = b.dialog_backgroundCoverColor || ("moono-lisa" == c ? "black" : "white"), c = b.dialog_backgroundCoverOpacity, d = b.baseFloatZIndex, b = CKEDITOR.tools.genKey(e, c, d), f = D[b]; CKEDITOR.document.getBody().addClass("cke_dialog_open"); f ? f.show() : (d = ['\x3cdiv tabIndex\x3d"-1" style\x3d"position: ', CKEDITOR.env.ie6Compat ? "absolute" : "fixed", "; z-index: ", d, "; top: 0px; left: 0px; ", "; width: 100%; height: 100%;",
                ...
                d.push("\x3c/div\x3e"), f = CKEDITOR.dom.element.createFromHtml(d.join("")), f.setOpacity(void 0 !== c ? c : .5), f.on("keydown", J), f.on("keypress", J), f.on("keyup", J), f.appendTo(CKEDITOR.document.getBody()), D[b] = f); a.focusManager.add(f); u = f; CKEDITOR.env.mac && CKEDITOR.env.webkit || f.focus()
        ...
        } function S(a) { var b = a.data.$.ctrlKey || a.data.$.metaKey, c = a.data.$.altKey, e = a.data.$.shiftKey, d = String.fromCharCode(a.data.$.keyCode); (b = x[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (e ? "SHIFT+" : "") + d]) && b.length && (b = b[b.length - 1], b.keyup && (b.keyup.call(b.uiElement, b.dialog, b.key), a.data.preventDefault())) } function T(a, b, c, e, d) {
            (x[c] || (x[c] = [])).push({
                uiElement: a,
                dialog: b, key: c, keyup: d || a.accessKeyUp, keydown: e || a.accessKeyDown
            })
        } function da(a) { for (var b in x) { for (var c = x[b], e = c.length - 1; 0 <= e; e--)c[e].dialog != a && c[e].uiElement != a || c.splice(e, 1); 0 === c.length && delete x[b] } } function ea(a, b) { a._.accessKeyMap[b] && a.selectPage(a._.accessKeyMap[b]) } function fa() { } var y = CKEDITOR.tools.cssLength, U, u, F = !CKEDITOR.env.ie || CKEDITOR.env.edge, Z = '\x3cdiv class\x3d"cke_reset_all cke_dialog_container {editorId} {editorDialogClass} {hidpi}" dir\x3d"{langDir}" style\x3d"' + (F ?
        ...
        CKEDITOR.dialog = function (a, b) {
            function c() { var a = n._.focusList; a.sort(function (a, b) { return a.tabIndex != b.tabIndex ? b.tabIndex - a.tabIndex : a.focusIndex - b.focusIndex }); for (var b = a.length, c = 0; c < b; c++)a[c].focusIndex = c } function e(a) {
                ...
                if (n == CKEDITOR.dialog._.currentTop) {
                    var c = b.data.getKeystroke(), d = "rtl" == a.lang.dir, g = [37, 38, 39, 40]; q = l = 0; if (9 == c || c == CKEDITOR.SHIFT + 9) e(c == CKEDITOR.SHIFT + 9 ? -1 : 1), q = 1; else if (c == CKEDITOR.ALT + 121 && !n._.tabBarMode && 1 < n.getPageCount()) z(n), q = 1; else if (-1 != CKEDITOR.tools.indexOf(g, c) && n._.tabBarMode) c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ?
                ...
                { name: b, definition: g, dialog: this }, a).definition; if (!("removeDialogTabs" in a._) && a.config.removeDialogTabs) { h = a.config.removeDialogTabs.split(";"); for (m = 0; m < h.length; m++)if (p = h[m].split(":"), 2 == p.length) { var r = p[0]; k[r] || (k[r] = []); k[r].push(p[1]) } a._.removeDialogTabs = k } if (a._.removeDialogTabs && (k = a._.removeDialogTabs[b])) for (m = 0; m < k.length; m++)g.removeContents(k[m]); if (g.onLoad) this.on("load", g.onLoad); if (g.onShow) this.on("show", g.onShow); if (g.onHide) this.on("hide", g.onHide); if (g.onOk) this.on("ok",
                    function (b) { a.fire("saveSnapshot"); setTimeout(function () { a.fire("saveSnapshot") }, 0); !1 === g.onOk.call(this, b) && (b.data.hide = !1) }); this.state = CKEDITOR.DIALOG_STATE_IDLE; if (g.onCancel) this.on("cancel", function (a) { !1 === g.onCancel.call(this, a) && (a.data.hide = !1) }); var n = this, t = function (a) { var b = n._.contents, c = !1, d; for (d in b) for (var e in b[d]) if (c = a.call(this, b[d][e])) return }; this.on("ok", function (a) {
                        ...
                        B.on("keydown", d, this); if (CKEDITOR.env.gecko) B.on("keypress",
                            f, this)
                    }); this.on("hide", function () { B.removeListener("keydown", d); CKEDITOR.env.gecko && B.removeListener("keypress", f); t(function (a) { X.apply(a) }) }); this.on("iframeAdded", function (a) { (new CKEDITOR.dom.document(a.data.iframe.$.contentWindow.document)).on("keydown", d, this, null, 0) }); this.on("show", function () {
            ...
            destroy: function () { this.hide(); this._.element.remove() }, resize: function (a, b) {
                ...
                var b =
                    this._.tabs[a] && this._.tabs[a][0]; b && 1 != this._.pageCount && b.isVisible() && (a == this._.currentTabId && this.selectPage(A.call(this)), b.hide(), this._.pageCount--, this.updateStyle())
    ...
    })(); CKEDITOR.config.plugins = 'dialogui,dialog,about,a11yhelp,basicstyles,blockquote,notification,button,toolbar,clipboard,panel,floatpanel,menu,contextmenu,resize,elementspath,enterkey,entities,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,wysiwygarea,indent,indentlist,list,magicline,maximize,pastetext,pastetools,pastefromgdocs,pastefromword,removeformat,showborders,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,tableselection,undo,lineutils,widgetselection,widget,filetools,notificationaggregator,uploadwidget,uploadimage,wsc,popup,filebrowser'; CKEDITOR.config.skin = 'moono-lisa'; (function () { var setIcons = function (icons, strip) { var path = CKEDITOR.getUrl('plugins/' + strip); icons = icons.split(','); for (var i = 0; i < icons.length; i++)CKEDITOR.skin.icons[icons[i]] = { path: path, offset: -icons[++i], bgsize: icons[++i] }; }; if (CKEDITOR.env.hidpi) setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,blockquote,168,,copy-rtl,192,,copy,216,,cut-rtl,240,,cut,264,,paste-rtl,288,,paste,312,,horizontalrule,336,,indent-rtl,360,,indent,384,,outdent-rtl,408,,outdent,432,,bulletedlist-rtl,456,,bulletedlist,480,,numberedlist-rtl,504,,numberedlist,528,,maximize,552,,pastetext-rtl,576,,pastetext,600,,pastefromword-rtl,624,,pastefromword,648,,removeformat,672,,source-rtl,696,,source,720,,specialchar,744,,scayt,768,,table,792,,redo-rtl,816,,redo,840,,undo-rtl,864,,undo,888,,spellchecker,912,', 'icons_hidpi.png'); else setIcons('about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,blockquote,168,auto,copy-rtl,192,auto,copy,216,auto,cut-rtl,240,auto,cut,264,auto,paste-rtl,288,auto,paste,312,auto,horizontalrule,336,auto,indent-rtl,360,auto,indent,384,auto,outdent-rtl,408,auto,outdent,432,auto,bulletedlist-rtl,456,auto,bulletedlist,480,auto,numberedlist-rtl,504,auto,numberedlist,528,auto,maximize,552,auto,pastetext-rtl,576,auto,pastetext,600,auto,pastefromword-rtl,624,auto,pastefromword,648,auto,removeformat,672,auto,source-rtl,696,auto,source,720,auto,specialchar,744,auto,scayt,768,auto,table,792,auto,redo-rtl,816,auto,redo,840,auto,undo-rtl,864,auto,undo,888,auto,spellchecker,912,auto', 'icons.png'); })(); CKEDITOR.lang.languages = { "en": 1, "ko": 1 };
}());